...
`;let e$=class extends W3mConnectingWidget{constructor(){super(),this.forceUpdate=()=>{this.requestUpdate()},window.addEventListener("resize",this.forceUpdate),g.Xs.sendEvent({type:"track",event:"SELECT_WALLET",properties:{name:this.wallet?.name??"WalletConnect",platform:"qrcode"}})}disconnectedCallback(){super.disconnectedCallback(),window.removeEventListener("resize",this.forceUpdate)}render(){return this.onRenderProxy(),v.dy`
    ...
    `}onRenderProxy(){!this.ready&&this.uri&&(this.timeout=setTimeout(()=>{this.ready=!0},200))}qrCodeTemplate(){if(!this.uri||!this.ready)return null;let t=this.getBoundingClientRect().width-40,s=this.wallet?this.wallet.name:void 0;return g.ConnectionController.setWcLinking(void 0),g.ConnectionController.setRecentWallet(this.wallet),v.dy`<wui-qr-code
      ...
      alt=${(0,x.o)(s)}
    ></wui-qr-code>`}};e$.styles=eA,e$=function(t,s,p,g){var m,v=arguments.length,_=v<3?s:null===g?g=Object.getOwnPropertyDescriptor(s,p):g;if("object"==typeof Reflect&&"function"==typeof Reflect.decorate)_=Reflect.decorate(t,s,p,g);else for(var x=t.length-1;x>=0;x--)(m=t[x])&&(_=(v<3?m(_):v>3?m(s,p,_):m(s,p))||_);return v>3&&_&&Object.defineProperty(s,p,_),_}([(0,m.customElement)("w3m-connecting-wc-qrcode")],e$);let eO=class extends v.oi{constructor(){if(super(),this.wallet=g.RouterController.state.data?.wallet,!this.wallet)throw Error("w3m-connecting-wc-unsupported: No wallet provided");g.Xs.sendEvent({type:"track",event:"SELECT_WALLET",properties:{name:this.wallet.name,platform:"browser"}})}render(){return v.dy`
      <wui-flex
        flexDirection="column"
        alignItems="center"
        .padding=${["3xl","xl","xl","xl"]}
      ...
      <w3m-mobile-download-links .wallet=${this.wallet}></w3m-mobile-download-links>
    `}};eO=function(t,s,p,g){var m,v=arguments.length,_=v<3?s:null===g?g=Object.getOwnPropertyDescriptor(s,p):g;if("object"==typeof Reflect&&"function"==typeof Reflect.decorate)_=Reflect.decorate(t,s,p,g);else for(var x=t.length-1;x>=0;x--)(m=t[x])&&(_=(v<3?m(_):v>3?m(s,p,_):m(s,p))||_);return v>3&&_&&Object.defineProperty(s,p,_),_}([(0,m.customElement)("w3m-connecting-wc-unsupported")],eO);let eD=class extends W3mConnectingWidget{constructor(){if(super(),!this.wallet)throw Error("w3m-connecting-wc-web: No wallet provided");this.onConnect=this.onConnectProxy.bind(this),this.secondaryBtnLabel="Open",this.secondaryLabel="Open and continue in a new browser tab",this.secondaryBtnIcon="externalLink",g.Xs.sendEvent({type:"track",event:"SELECT_WALLET",properties:{name:this.wallet.name,platform:"web"}})}onConnectProxy(){if(this.wallet?.webapp_link&&this.uri)try{this.error=!1;let{webapp_link:t,name:s}=this.wallet,{redirect:p,href:m}=g.j1.formatUniversalUrl(t,this.uri);g.ConnectionController.setWcLinking({name:s,href:m}),g.ConnectionController.setRecentWallet(this.wallet),g.j1.openHref(p,"_blank")}catch{this.error=!0}}};eD=function(t,s,p,g){var m,v=arguments.length,_=v<3?s:null===g?g=Object.getOwnPropertyDescriptor(s,p):g;if("object"==typeof Reflect&&"function"==typeof Reflect.decorate)_=Reflect.decorate(t,s,p,g);else for(var x=t.length-1;x>=0;x--)(m=t[x])&&(_=(v<3?m(_):v>3?m(s,p,_):m(s,p))||_);return v>3&&_&&Object.defineProperty(s,p,_),_}([(0,m.customElement)("w3m-connecting-wc-web")],eD);var eT=v.iv`
  wui-icon-link[data-hidden='true'] {
    opacity: 0 !important;
    pointer-events: none;
  }
`,w3m_header_decorate=function(t,s,p,g){var m,v=arguments.length,_=v<3?s:null===g?g=Object.getOwnPropertyDescriptor(s,p):g;if("object"==typeof Reflect&&"function"==typeof Reflect.decorate)_=Reflect.decorate(t,s,p,g);else for(var x=t.length-1;x>=0;x--)(m=t[x])&&(_=(v<3?m(_):v>3?m(s,p,_):m(s,p))||_);return v>3&&_&&Object.defineProperty(s,p,_),_};function headings(){let t=g.RouterController.state.data?.connector?.name,s=g.RouterController.state.data?.wallet?.name,p=g.RouterController.state.data?.network?.name,m=s??t;return{Connect:"Connect Wallet",Account:void 0,ConnectingExternal:m??"Connect Wallet",ConnectingWalletConnect:m??"WalletConnect",Networks:"Choose Network",SwitchNetwork:p??"Switch Network",AllWallets:"All Wallets",WhatIsANetwork:"What is a network?",WhatIsAWallet:"What is a wallet?",GetWallet:"Get a Wallet",Downloads:m?`Get ${m}`:"Downloads"}}let eI=class extends v.oi{constructor(){super(),this.unsubscribe=[],this.heading=headings()[g.RouterController.state.view],this.buffering=!1,this.showBack=!1,this.unsubscribe.push(g.RouterController.subscribeKey("view",t=>{this.onViewChange(t),this.onHistoryChange()}),g.ConnectionController.subscribeKey("buffering",t=>this.buffering=t))}disconnectCallback(){this.unsubscribe.forEach(t=>t())}render(){return v.dy`
...
`,w3m_mobile_download_links_decorate=function(t,s,p,g){var m,v=arguments.length,_=v<3?s:null===g?g=Object.getOwnPropertyDescriptor(s,p):g;if("object"==typeof Reflect&&"function"==typeof Reflect.decorate)_=Reflect.decorate(t,s,p,g);else for(var x=t.length-1;x>=0;x--)(m=t[x])&&(_=(v<3?m(_):v>3?m(s,p,_):m(s,p))||_);return v>3&&_&&Object.defineProperty(s,p,_),_};let eM=class extends v.oi{constructor(){super(...arguments),this.wallet=void 0}render(){if(!this.wallet)return this.style.display="none",null;let{name:t,app_store:s,play_store:p,chrome_store:_,homepage:x}=this.wallet,T=g.j1.isMobile(),F=g.j1.isIos(),W=g.j1.isAndroid(),Z=[s,p,x,_].filter(Boolean).length>1,Q=m.UiHelperUtil.getTruncateString({string:t,charsStart:12,charsEnd:0,truncate:"end"});return Z&&!T?v.dy`
      ...
      `:p&&W?v.dy`
        <wui-cta-button
          ...
          @click=${this.onPlayStore.bind(this)}
        ></wui-cta-button>
      `:(this.style.display="none",null)}onAppStore(){this.wallet?.app_store&&g.j1.openHref(this.wallet.app_store,"_blank")}onPlayStore(){this.wallet?.play_store&&g.j1.openHref(this.wallet.play_store,"_blank")}onHomePage(){this.wallet?.homepage&&g.j1.openHref(this.wallet.homepage,"_blank")}};eM.styles=[eU],w3m_mobile_download_links_decorate([(0,_.Cb)({type:Object})],eM.prototype,"wallet",void 0),eM=w3m_mobile_download_links_decorate([(0,m.customElement)("w3m-mobile-download-links")],eM);var ej=v.iv`
  :host {
    display: block;
    position: absolute;
    opacity: 0;
