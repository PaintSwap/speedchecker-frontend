...
`,wui_card_select_loader_decorate=function(t,s,p,g){var m,v=arguments.length,_=v<3?s:null===g?g=Object.getOwnPropertyDescriptor(s,p):g;if("object"==typeof Reflect&&"function"==typeof Reflect.decorate)_=Reflect.decorate(t,s,p,g);else for(var x=t.length-1;x>=0;x--)(m=t[x])&&(_=(v<3?m(_):v>3?m(s,p,_):m(s,p))||_);return v>3&&_&&Object.defineProperty(s,p,_),_};let tj=class extends _.oi{constructor(){super(...arguments),this.type="wallet"}render(){return _.dy`
    ...
    `}shimmerTemplate(){return"network"===this.type?_.dy` <wui-shimmer
          ...
          borderRadius="xs"
        ></wui-shimmer>
        ${tU}`:_.dy`<wui-shimmer width="56px" height="56px" borderRadius="xs"></wui-shimmer>`}};tj.styles=[x,T,tM],wui_card_select_loader_decorate([(0,Y.Cb)()],tj.prototype,"type",void 0),tj=wui_card_select_loader_decorate([customElement("wui-card-select-loader")],tj);let tL=_.YP`<svg width="86" height="96" fill="none">
  <path
...
`,wui_tooltip_decorate=function(t,s,p,g){var m,v=arguments.length,_=v<3?s:null===g?g=Object.getOwnPropertyDescriptor(s,p):g;if("object"==typeof Reflect&&"function"==typeof Reflect.decorate)_=Reflect.decorate(t,s,p,g);else for(var x=t.length-1;x>=0;x--)(m=t[x])&&(_=(v<3?m(_):v>3?m(s,p,_):m(s,p))||_);return v>3&&_&&Object.defineProperty(s,p,_),_};let rN=class extends _.oi{constructor(){super(...arguments),this.placement="top",this.message=""}render(){return _.dy`<wui-icon
        ...
        name="cursor"
      ></wui-icon>
      <wui-text color="inherit" variant="small-500">${this.message}</wui-text>`}};rN.styles=[x,T,rB],wui_tooltip_decorate([(0,Y.Cb)()],rN.prototype,"placement",void 0),wui_tooltip_decorate([(0,Y.Cb)()],rN.prototype,"message",void 0),rN=wui_tooltip_decorate([customElement("wui-tooltip")],rN);var rU=_.iv`
  :host {
    display: grid;
    width: inherit;
    height: inherit;
...
`,wui_grid_decorate=function(t,s,p,g){var m,v=arguments.length,_=v<3?s:null===g?g=Object.getOwnPropertyDescriptor(s,p):g;if("object"==typeof Reflect&&"function"==typeof Reflect.decorate)_=Reflect.decorate(t,s,p,g);else for(var x=t.length-1;x>=0;x--)(m=t[x])&&(_=(v<3?m(_):v>3?m(s,p,_):m(s,p))||_);return v>3&&_&&Object.defineProperty(s,p,_),_};let rM=class extends _.oi{render(){return this.style.cssText=`
      ...
      margin-bottom: ${this.margin&&tC.getSpacingStyles(this.margin,2)};
      margin-left: ${this.margin&&tC.getSpacingStyles(this.margin,3)};
    `,_.dy`<slot></slot>`}};rM.styles=[x,rU],wui_grid_decorate([(0,Y.Cb)()],rM.prototype,"gridTemplateRows",void 0),wui_grid_decorate([(0,Y.Cb)()],rM.prototype,"gridTemplateColumns",void 0),wui_grid_decorate([(0,Y.Cb)()],rM.prototype,"justifyItems",void 0),wui_grid_decorate([(0,Y.Cb)()],rM.prototype,"alignItems",void 0),wui_grid_decorate([(0,Y.Cb)()],rM.prototype,"justifyContent",void 0),wui_grid_decorate([(0,Y.Cb)()],rM.prototype,"alignContent",void 0),wui_grid_decorate([(0,Y.Cb)()],rM.prototype,"columnGap",void 0),wui_grid_decorate([(0,Y.Cb)()],rM.prototype,"rowGap",void 0),wui_grid_decorate([(0,Y.Cb)()],rM.prototype,"gap",void 0),wui_grid_decorate([(0,Y.Cb)()],rM.prototype,"padding",void 0),wui_grid_decorate([(0,Y.Cb)()],rM.prototype,"margin",void 0),rM=wui_grid_decorate([customElement("wui-grid")],rM);var rj=_.iv`
  :host {
    position: relative;
    display: flex;
    width: 100%;
