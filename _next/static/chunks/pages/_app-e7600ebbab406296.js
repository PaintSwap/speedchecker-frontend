...
Read more: https://wagmi.sh/core/providers/jsonRpc`)}return{chains:T,publicClient:({chainId:s})=>{let W=T.find(t=>t.id===s)??t[0],Z=F[W.id];if(!Z||!Z[0])throw Error(`No providers configured for chain "${W.id}"`);let Q=createPublicClient({batch:p,chain:W,transport:fallback(Z.map(t=>(function(t,s={}){let{batch:p,fetchOptions:g,key:m="http",name:v="HTTP JSON-RPC",retryDelay:_}=s;return({chain:x,retryCount:T,timeout:F})=>{let{batchSize:W=1e3,wait:Z=0}="object"==typeof p?p:{},Q=s.retryCount??T,Y=F??s.timeout??1e4,X=t||x?.rpcUrls.default.http[0];if(!X)throw new UrlRequiredError;return(0,eV.q)({key:m,name:v,async request({method:s,params:m}){let v={method:s,params:m},{schedule:_}=(0,eY.S)({id:`${t}`,wait:Z,shouldSplitBatch:t=>t.length>W,fn:t=>e1.http(X,{body:t,fetchOptions:g,timeout:Y})}),fn=async t=>p?_(t):[await e1.http(X,{body:t,fetchOptions:g,timeout:Y})],[{error:x,result:T}]=await fn(v);if(x)throw new eQ.bs({body:v,error:x,url:X});return T},retryCount:Q,retryDelay:_,timeout:Y,type:"http"},{fetchOptions:g,url:t})}})(t,{timeout:x})),{rank:m,retryCount:v,retryDelay:_}),pollingInterval:g});return Object.assign(Q,{chains:T})},webSocketPublicClient:({chainId:s})=>{let F=T.find(t=>t.id===s)??t[0],Z=W[F.id];if(!Z||!Z[0])return;let Q=createPublicClient({batch:p,chain:F,transport:fallback(Z.map(t=>(function(t,s={}){let{key:p="webSocket",name:g="WebSocket JSON-RPC",retryDelay:m}=s;return({chain:v,retryCount:_,timeout:x})=>{let T=s.retryCount??_,F=x??s.timeout??1e4,W=t||v?.rpcUrls.default.webSocket?.[0];if(!W)throw new UrlRequiredError;return(0,eV.q)({key:p,name:g,async request({method:t,params:s}){let p={method:t,params:s},g=await getSocket(W),{error:m,result:v}=await e1.webSocketAsync(g,{body:p,timeout:F});if(m)throw new eQ.bs({body:p,error:m,url:W});return v},retryCount:T,retryDelay:m,timeout:F,type:"webSocket"},{getSocket:()=>getSocket(W),async subscribe({params:t,onData:s,onError:p}){let g=await getSocket(W),{result:m}=await new Promise((m,v)=>e1.webSocket(g,{body:{method:"eth_subscribe",params:t},onResponse(t){if(t.error){v(t.error),p?.(t.error);return}if("number"==typeof t.id){m(t);return}"eth_subscription"===t.method&&s(t.params)}}));return{subscriptionId:m,unsubscribe:async()=>new Promise(t=>e1.webSocket(g,{body:{method:"eth_unsubscribe",params:[m]},onResponse:t}))}}})}})(t,{timeout:x})),{rank:m,retryCount:v,retryDelay:_}),pollingInterval:g});return Object.assign(Q,{chains:T})}}}var e4=class extends Error{constructor({activeChain:t,targetChain:s}){super(`Chain mismatch: Expected "${s}", received "${t}".`),this.name="ChainMismatchError"}},e8=class extends Error{constructor({chainId:t,connectorId:s}){super(`Chain "${t}" not configured${s?` for connector "${s}"`:""}.`),this.name="ChainNotConfigured"}},e7=class extends Error{constructor(){super(...arguments),this.name="ConnectorAlreadyConnectedError",this.message="Connector already connected"}},e9=class extends Error{constructor(){super(...arguments),this.name="ConfigChainsNotFound",this.message="No chains were found on the wagmi config. Some functions that require a chain may not work."}},tt=class extends Error{constructor({connector:t}){super(`"${t.name}" does not support programmatic chain switching.`),this.name="SwitchChainNotSupportedError"}},findAndReplace=(t,{find:s,replace:p})=>t&&s(t)?p(t):"object"!=typeof t?t:Array.isArray(t)?t.map(t=>findAndReplace(t,{find:s,replace:p})):t instanceof Object?Object.entries(t).reduce((t,[g,m])=>({...t,[g]:findAndReplace(m,{find:s,replace:p})}),{}):t;function deserialize(t){let s=JSON.parse(t),p=findAndReplace(s,{find:t=>"string"==typeof t&&t.startsWith("#bigint."),replace:t=>BigInt(t.replace("#bigint.",""))});return p}function getCallParameters(t){return{accessList:t.accessList,account:t.account,blockNumber:t.blockNumber,blockTag:t.blockTag,data:t.data,gas:t.gas,gasPrice:t.gasPrice,maxFeePerGas:t.maxFeePerGas,maxPriorityFeePerGas:t.maxPriorityFeePerGas,nonce:t.nonce,to:t.to,value:t.value}}function getSendTransactionParameters(t){return{accessList:t.accessList,account:t.account,data:t.data,gas:t.gas,gasPrice:t.gasPrice,maxFeePerGas:t.maxFeePerGas,maxPriorityFeePerGas:t.maxPriorityFeePerGas,nonce:t.nonce,to:t.to,value:t.value}}function getUnit(t){return"number"==typeof t?t:"wei"===t?0:Math.abs(e5.Bd[t])}function getReferenceKey(t,s){return t.slice(0,s).join(".")||"."}function getCutoff(t,s){let{length:p}=t;for(let g=0;g<p;++g)if(t[g]===s)return g+1;return 0}function serialize(t,s,p,g){return JSON.stringify(t,function(t,s){let p="function"==typeof t,g="function"==typeof s,m=[],v=[];return function(_,x){if("object"==typeof x){if(m.length){let t=getCutoff(m,this);0===t?m[m.length]=this:(m.splice(t),v.splice(t)),v[v.length]=_;let p=getCutoff(m,x);if(0!==p)return g?s.call(this,_,x,getReferenceKey(v,p)):`[ref=${getReferenceKey(v,p)}]`}else m[0]=x,v[0]=_}return p?t.call(this,_,x):x}}((t,p)=>{let g="bigint"==typeof p?`#bigint.${p.toString()}`:p;return s?.(t,g)||g},g),p??void 0)}var tr={getItem:t=>"",setItem:(t,s)=>null,removeItem:t=>null};function createStorage({deserialize:t=deserialize,key:s="wagmi",serialize:p=serialize,storage:g}){return{...g,getItem:(p,m=null)=>{let v=g.getItem(`${s}.${p}`);try{return v?t(v):m}catch(t){return console.warn(t),m}},setItem:(t,m)=>{if(null===m)g.removeItem(`${s}.${t}`);else try{g.setItem(`${s}.${t}`,p(m))}catch(t){console.error(t)}},removeItem:t=>g.removeItem(`${s}.${t}`)}}var tn="store",ti=class{constructor({autoConnect:t=!1,connectors:s=[new T._],publicClient:p,storage:x=createStorage({storage:"undefined"!=typeof window?window.localStorage:tr}),logger:F={warn:console.warn},webSocketPublicClient:W}){let Z;__privateAdd(this,v),this.publicClients=new Map,this.webSocketPublicClients=new Map,__privateAdd(this,g,void 0),__privateAdd(this,m,void 0),this.args={autoConnect:t,connectors:s,logger:F,publicClient:p,storage:x,webSocketPublicClient:W};let Q="disconnected";if(t)try{let t=x.getItem(tn),s=t?.state?.data;Q=s?.account?"reconnecting":"connecting",Z=s?.chain?.id}catch(t){}let Y="function"==typeof s?s():s;Y.forEach(t=>t.setStorage(x)),this.store=createStore(subscribeWithSelector(persist(()=>({connectors:Y,publicClient:this.getPublicClient({chainId:Z}),status:Q,webSocketPublicClient:this.getWebSocketPublicClient({chainId:Z})}),{name:tn,storage:x,partialize:s=>({...t&&{data:{account:s?.data?.account,chain:s?.data?.chain}},chains:s?.chains}),version:2}))),this.storage=x,__privateSet(this,m,x?.getItem("wallet")),__privateMethod(this,v,_).call(this),t&&"undefined"!=typeof window&&setTimeout(async()=>await this.autoConnect(),0)}get chains(){return this.store.getState().chains}get connectors(){return this.store.getState().connectors}get connector(){return this.store.getState().connector}get data(){return this.store.getState().data}get error(){return this.store.getState().error}get lastUsedChainId(){return this.data?.chain?.id}get publicClient(){return this.store.getState().publicClient}get status(){return this.store.getState().status}get subscribe(){return this.store.subscribe}get webSocketPublicClient(){return this.store.getState().webSocketPublicClient}setState(t){let s="function"==typeof t?t(this.store.getState()):t;this.store.setState(s,!0)}clearState(){this.setState(t=>({...t,chains:void 0,connector:void 0,data:void 0,error:void 0,status:"disconnected"}))}async destroy(){this.connector&&await this.connector.disconnect?.(),__privateSet(this,g,!1),this.clearState(),this.store.destroy()}async autoConnect(){if(__privateGet(this,g))return;__privateSet(this,g,!0),this.setState(t=>({...t,status:t.data?.account?"reconnecting":"connecting"}));let t=__privateGet(this,m)?[...this.connectors].sort(t=>t.id===__privateGet(this,m)?-1:1):this.connectors,s=!1;for(let p of t){if(!p.ready||!p.isAuthorized)continue;let t=await p.isAuthorized();if(!t)continue;let g=await p.connect();this.setState(t=>({...t,connector:p,chains:p?.chains,data:g,status:"connected"})),s=!0;break}return s||this.setState(t=>({...t,data:void 0,status:"disconnected"})),__privateSet(this,g,!1),this.data}setConnectors(t){this.args={...this.args,connectors:t};let s="function"==typeof t?t():t;s.forEach(t=>t.setStorage(this.args.storage)),this.setState(t=>({...t,connectors:s}))}getPublicClient({chainId:t}={}){let s=this.publicClients.get(-1);if(s&&s?.chain.id===t||(s=this.publicClients.get(t??-1)))return s;let{publicClient:p}=this.args;return s="function"==typeof p?p({chainId:t}):p,this.publicClients.set(t??-1,s),s}setPublicClient(t){let s=this.data?.chain?.id;this.args={...this.args,publicClient:t},this.publicClients.clear(),this.setState(t=>({...t,publicClient:this.getPublicClient({chainId:s})}))}getWebSocketPublicClient({chainId:t}={}){let s=this.webSocketPublicClients.get(-1);if(s&&s?.chain.id===t||(s=this.webSocketPublicClients.get(t??-1)))return s;let{webSocketPublicClient:p}=this.args;return(s="function"==typeof p?p({chainId:t}):p)&&this.webSocketPublicClients.set(t??-1,s),s}setWebSocketPublicClient(t){let s=this.data?.chain?.id;this.args={...this.args,webSocketPublicClient:t},this.webSocketPublicClients.clear(),this.setState(t=>({...t,webSocketPublicClient:this.getWebSocketPublicClient({chainId:s})}))}setLastUsedConnector(t=null){this.storage?.setItem("wallet",t)}};function createConfig(t){let s=new ti(t);return x=s,s}function getConfig(){if(!x)throw Error("No wagmi config found. Ensure you have set up a config: https://wagmi.sh/react/config");return x}async function connect({chainId:t,connector:s}){let p=getConfig(),g=p.connector;if(g&&s.id===g.id)throw new e7;try{p.setState(t=>({...t,status:"connecting"}));let g=await s.connect({chainId:t});return p.setLastUsedConnector(s.id),p.setState(t=>({...t,connector:s,chains:s?.chains,data:g,status:"connected"})),p.storage.setItem("connected",!0),{...g,connector:s}}catch(t){throw p.setState(t=>({...t,status:t.connector?"connected":"disconnected"})),t}}async function disconnect(){let t=getConfig();t.connector&&await t.connector.disconnect(),t.clearState(),t.storage.removeItem("connected")}g=new WeakMap,m=new WeakMap,v=new WeakSet,_=function(){let onChange=t=>{this.setState(s=>({...s,data:{...s.data,...t}}))},onDisconnect=()=>{this.clearState()},onError=t=>{this.setState(s=>({...s,error:t}))};this.store.subscribe(({connector:t})=>t,(t,s)=>{s?.off?.("change",onChange),s?.off?.("disconnect",onDisconnect),s?.off?.("error",onError),t&&(t.on?.("change",onChange),t.on?.("disconnect",onDisconnect),t.on?.("error",onError))});let{publicClient:t,webSocketPublicClient:s}=this.args;("function"==typeof t||"function"==typeof s)&&this.store.subscribe(({data:t})=>t?.chain?.id,t=>{this.setState(s=>({...s,publicClient:this.getPublicClient({chainId:t}),webSocketPublicClient:this.getWebSocketPublicClient({chainId:t})}))})};var to=[{type:"event",name:"Approval",inputs:[{indexed:!0,name:"owner",type:"address"},{indexed:!0,name:"spender",type:"address"},{indexed:!1,name:"value",type:"uint256"}]},{type:"event",name:"Transfer",inputs:[{indexed:!0,name:"from",type:"address"},{indexed:!0,name:"to",type:"address"},{indexed:!1,name:"value",type:"uint256"}]},{type:"function",name:"allowance",stateMutability:"view",inputs:[{name:"owner",type:"address"},{name:"spender",type:"address"}],outputs:[{name:"",type:"uint256"}]},{type:"function",name:"approve",stateMutability:"nonpayable",inputs:[{name:"spender",type:"address"},{name:"amount",type:"uint256"}],outputs:[{name:"",type:"bool"}]},{type:"function",name:"balanceOf",stateMutability:"view",inputs:[{name:"account",type:"address"}],outputs:[{name:"",type:"uint256"}]},{type:"function",name:"decimals",stateMutability:"view",inputs:[],outputs:[{name:"",type:"uint8"}]},{type:"function",name:"name",stateMutability:"view",inputs:[],outputs:[{name:"",type:"string"}]},{type:"function",name:"symbol",stateMutability:"view",inputs:[],outputs:[{name:"",type:"string"}]},{type:"function",name:"totalSupply",stateMutability:"view",inputs:[],outputs:[{name:"",type:"uint256"}]},{type:"function",name:"transfer",stateMutability:"nonpayable",inputs:[{name:"recipient",type:"address"},{name:"amount",type:"uint256"}],outputs:[{name:"",type:"bool"}]},{type:"function",name:"transferFrom",stateMutability:"nonpayable",inputs:[{name:"sender",type:"address"},{name:"recipient",type:"address"},{name:"amount",type:"uint256"}],outputs:[{name:"",type:"bool"}]}],ta=[{type:"event",name:"Approval",inputs:[{indexed:!0,name:"owner",type:"address"},{indexed:!0,name:"spender",type:"address"},{indexed:!1,name:"value",type:"uint256"}]},{type:"event",name:"Transfer",inputs:[{indexed:!0,name:"from",type:"address"},{indexed:!0,name:"to",type:"address"},{indexed:!1,name:"value",type:"uint256"}]},{type:"function",name:"allowance",stateMutability:"view",inputs:[{name:"owner",type:"address"},{name:"spender",type:"address"}],outputs:[{name:"",type:"uint256"}]},{type:"function",name:"approve",stateMutability:"nonpayable",inputs:[{name:"spender",type:"address"},{name:"amount",type:"uint256"}],outputs:[{name:"",type:"bool"}]},{type:"function",name:"balanceOf",stateMutability:"view",inputs:[{name:"account",type:"address"}],outputs:[{name:"",type:"uint256"}]},{type:"function",name:"decimals",stateMutability:"view",inputs:[],outputs:[{name:"",type:"uint8"}]},{type:"function",name:"name",stateMutability:"view",inputs:[],outputs:[{name:"",type:"bytes32"}]},{type:"function",name:"symbol",stateMutability:"view",inputs:[],outputs:[{name:"",type:"bytes32"}]},{type:"function",name:"totalSupply",stateMutability:"view",inputs:[],outputs:[{name:"",type:"uint256"}]},{type:"function",name:"transfer",stateMutability:"nonpayable",inputs:[{name:"recipient",type:"address"},{name:"amount",type:"uint256"}],outputs:[{name:"",type:"bool"}]},{type:"function",name:"transferFrom",stateMutability:"nonpayable",inputs:[{name:"sender",type:"address"},{name:"recipient",type:"address"},{name:"amount",type:"uint256"}],outputs:[{name:"",type:"bool"}]}];function getPublicClient({chainId:t}={}){let s=getConfig();return t&&s.getPublicClient({chainId:t})||s.publicClient}async function getWalletClient({chainId:t}={}){let s=getConfig(),p=await s.connector?.getWalletClient?.({chainId:t})||null;return p}function getWebSocketPublicClient({chainId:t}={}){let s=getConfig();return t&&s.getWebSocketPublicClient({chainId:t})||s.webSocketPublicClient}function watchPublicClient(t,s){let p=getConfig(),handleChange=async()=>s(getPublicClient(t)),g=p.subscribe(({publicClient:t})=>t,handleChange);return g}function watchWalletClient({chainId:t},s){let p=getConfig(),handleChange=async({chainId:p})=>{if(t&&p&&t!==p)return;let g=await getWalletClient({chainId:t});return getConfig().connector?s(g):s(null)},g=p.subscribe(({data:t,connector:s})=>({account:t?.account,chainId:t?.chain?.id,connector:s}),handleChange,{equalityFn:shallow$1});return g}function watchWebSocketPublicClient(t,s){let p=getConfig(),handleChange=async()=>s(getWebSocketPublicClient(t)),g=p.subscribe(({webSocketPublicClient:t})=>t,handleChange);return g}async function prepareWriteContract({abi:t,address:s,args:p,chainId:g,dataSuffix:m,functionName:v,walletClient:_,...x}){let T=getPublicClient({chainId:g}),F=_??await getWalletClient({chainId:g});if(!F)throw new e2.N;g&&assertActiveChain({chainId:g});let{account:W,accessList:Z,blockNumber:Q,blockTag:Y,gas:X,gasPrice:J,maxFeePerGas:en,maxPriorityFeePerGas:ei,nonce:eo,value:ea}=getCallParameters(x),{result:es,request:el}=await T.simulateContract({abi:t,address:s,functionName:v,args:p,account:W||F.account,accessList:Z,blockNumber:Q,blockTag:Y,dataSuffix:m,gas:X,gasPrice:J,maxFeePerGas:en,maxPriorityFeePerGas:ei,nonce:eo,value:ea}),ec=t.filter(t=>"name"in t&&t.name===v);return{mode:"prepared",request:{...el,abi:ec,chainId:g},result:es}}async function chunk_TSH6VVF4_multicall({chainId:t,contracts:s,blockNumber:p,blockTag:g,...m}){let v=getPublicClient({chainId:t});if(!v.chains)throw new e9;if(t&&v.chain.id!==t)throw new e8({chainId:t});return v.multicall({allowFailure:m.allowFailure??!0,blockNumber:p,blockTag:g,contracts:s})}async function chunk_TSH6VVF4_readContract({address:t,account:s,chainId:p,abi:g,args:m,functionName:v,blockNumber:_,blockTag:x}){let T=getPublicClient({chainId:p});return T.readContract({abi:g,address:t,account:s,functionName:v,args:m,blockNumber:_,blockTag:x})}async function readContracts({contracts:t,blockNumber:s,blockTag:p,...g}){let{allowFailure:m=!0}=g;try{let g=getPublicClient(),v=t.reduce((t,s,p)=>{let m=s.chainId??g.chain.id;return{...t,[m]:[...t[m]||[],{contract:s,index:p}]}},{}),_=(await Promise.all(Object.entries(v).map(([t,g])=>chunk_TSH6VVF4_multicall({allowFailure:m,chainId:parseInt(t),contracts:g.map(({contract:t})=>t),blockNumber:s,blockTag:p})))).flat(),x=Object.values(v).flatMap(t=>t.map(({index:t})=>t));return _.reduce((t,s,p)=>(t&&(t[x[p]]=s),t),[])}catch(g){if(g instanceof eo.uq)throw g;let promises=()=>t.map(t=>chunk_TSH6VVF4_readContract({...t,blockNumber:s,blockTag:p}));if(m)return(await Promise.allSettled(promises())).map(t=>"fulfilled"===t.status?{result:t.value,status:"success"}:{error:t.reason,result:void 0,status:"failure"});return await Promise.all(promises())}}async function writeContract(t){let s;let p=await getWalletClient({chainId:t.chainId});if(!p)throw new e2.N;if(t.chainId&&assertActiveChain({chainId:t.chainId}),"prepared"===t.mode)s=t.request;else{let{chainId:p,mode:g,...m}=t,v=await prepareWriteContract(m);s=v.request}let g=await p.writeContract({...s,chain:t.chainId?{id:t.chainId}:null});return{hash:g}}async function fetchBalance({address:t,chainId:s,formatUnits:p,token:g}){let m=getConfig(),v=getPublicClient({chainId:s});if(g){let fetchContractBalance=async({abi:m})=>{let v={abi:m,address:g,chainId:s},[_,x,T]=await readContracts({allowFailure:!1,contracts:[{...v,functionName:"balanceOf",args:[t]},{...v,functionName:"decimals"},{...v,functionName:"symbol"}]});return{decimals:x,formatted:(0,e3.b)(_??"0",getUnit(p??x)),symbol:T,value:_}};try{return await fetchContractBalance({abi:to})}catch(t){if(t instanceof eo.uq){let{symbol:t,...s}=await fetchContractBalance({abi:ta});return{symbol:(0,eA.rR)((0,X.f)(t,{dir:"right"})),...s}}throw t}}let _=[...m.publicClient.chains||[],...m.chains??[]],x=await v.getBalance({address:t}),T=_.find(t=>t.id===v.chain.id);return{decimals:T?.nativeCurrency.decimals??18,formatted:(0,e3.b)(x??"0",getUnit(p??18)),symbol:T?.nativeCurrency.symbol??"ETH",value:x}}function getAccount(){let{data:t,connector:s,status:p}=getConfig();switch(p){case"connected":return{address:t?.account,connector:s,isConnected:!0,isConnecting:!1,isDisconnected:!1,isReconnecting:!1,status:p};case"reconnecting":return{address:t?.account,connector:s,isConnected:!!t?.account,isConnecting:!1,isDisconnected:!1,isReconnecting:!0,status:p};case"connecting":return{address:t?.account,connector:s,isConnected:!1,isConnecting:!0,isDisconnected:!1,isReconnecting:!1,status:p};case"disconnected":return{address:void 0,connector:void 0,isConnected:!1,isConnecting:!1,isDisconnected:!0,isReconnecting:!1,status:p}}}function getNetwork(){let t=getConfig(),s=t.data?.chain?.id,p=t.chains??[],g=[...t.publicClient?.chains||[],...p].find(t=>t.id===s)??{id:s,name:`Chain ${s}`,network:`${s}`,nativeCurrency:{name:"Ether",decimals:18,symbol:"ETH"},rpcUrls:{default:{http:[""]},public:{http:[""]}}};return{chain:s?{...g,...t.data?.chain,id:s}:void 0,chains:p}}async function switchNetwork({chainId:t}){let{connector:s}=getConfig();if(!s)throw new e2.N;if(!s.switchChain)throw new tt({connector:s});return s.switchChain(t)}function watchAccount(t,{selector:s=t=>t}={}){let p=getConfig(),g=p.subscribe(({data:t,connector:p,status:g})=>s({address:t?.account,connector:p,status:g}),()=>t(getAccount()),{equalityFn:shallow$1});return g}function watchNetwork(t,{selector:s=t=>t}={}){let p=getConfig(),g=p.subscribe(({data:t,chains:p})=>s({chainId:t?.chain?.id,chains:p}),()=>t(getNetwork()),{equalityFn:shallow$1});return g}async function fetchEnsAvatar({name:t,chainId:s}){let{normalize:g}=await p.e(765).then(p.bind(p,26765)),m=getPublicClient({chainId:s}),v=await m.getEnsAvatar({name:g(t)});return v}async function fetchEnsName({address:t,chainId:s}){let p=getPublicClient({chainId:s});return p.getEnsName({address:(0,e6.K)(t)})}async function fetchBlockNumber({chainId:t}={}){let s=getPublicClient({chainId:t}),p=await s.getBlockNumber();return p}async function waitForTransaction({chainId:t,confirmations:s=1,hash:p,onReplaced:g,timeout:m=0}){let v=getPublicClient({chainId:t}),_=await v.waitForTransactionReceipt({hash:p,confirmations:s,onReplaced:g,timeout:m});if("reverted"===_.status){let t=await v.getTransaction({hash:_.transactionHash}),s=await v.call({...t,gasPrice:"eip1559"!==t.type?t.gasPrice:void 0,maxFeePerGas:"eip1559"===t.type?t.maxFeePerGas:void 0,maxPriorityFeePerGas:"eip1559"===t.type?t.maxPriorityFeePerGas:void 0}),p=(0,eA.rR)(`0x${s.substring(138)}`);throw Error(p)}return _}function assertActiveChain({chainId:t}){let{chain:s,chains:p}=getNetwork(),g=s?.id;if(g&&t!==g)throw new e4({activeChain:p.find(t=>t.id===g)?.name??`Chain ${g}`,targetChain:p.find(s=>s.id===t)?.name??`Chain ${t}`})}},36635:function(t,s,p){"use strict";p.d(s,{AccountController:function(){return x},ApiController:function(){return ed},WM:function(){return Q},fz:function(){return e$},Lr:function(){return eO},ConnectionController:function(){return eC},ConnectorController:function(){return X},bq:function(){return m},j1:function(){return v},Xs:function(){return em},IN:function(){return ev},NetworkController:function(){return eo},OptionsController:function(){return es},Ie:function(){return en},RouterController:function(){return ew},SnackController:function(){return eE},MO:function(){return W},ThemeController:function(){return eS}});var g=p(17832);function subscribeKey(t,s,p,m){let v=t[s];return(0,g.Ld)(t,()=>{let g=t[s];Object.is(v,g)||p(v=g)},m)}Symbol();let m={FOUR_MINUTES_MS:24e4,TEN_SEC_MS:1e4,ONE_SEC_MS:1e3,RESTRICTED_TIMEZONES:["ASIA/SHANGHAI","ASIA/URUMQI","ASIA/CHONGQING","ASIA/HARBIN","ASIA/KASHGAR","ASIA/MACAU","ASIA/HONG_KONG","ASIA/MACAO","ASIA/BEIJING","ASIA/HARBIN"]},v={isMobile:()=>"undefined"!=typeof window&&!!(window.matchMedia("(pointer:coarse)").matches||/Android|webOS|iPhone|iPad|iPod|BlackBerry|Opera Mini/u.test(navigator.userAgent)),isAndroid(){let t=navigator.userAgent.toLowerCase();return v.isMobile()&&t.includes("android")},isIos(){let t=navigator.userAgent.toLowerCase();return v.isMobile()&&(t.includes("iphone")||t.includes("ipad"))},isClient:()=>"undefined"!=typeof window,isPairingExpired:t=>!t||t-Date.now()<=m.TEN_SEC_MS,isAllowedRetry:t=>Date.now()-t>=m.ONE_SEC_MS,copyToClopboard(t){navigator.clipboard.writeText(t)},getPairingExpiry:()=>Date.now()+m.FOUR_MINUTES_MS,getPlainAddress:t=>t.split(":")[2],wait:async t=>new Promise(s=>{setTimeout(s,t)}),debounce(t,s=500){let p;return(...g)=>{p&&clearTimeout(p),p=setTimeout(function(){t(...g)},s)}},isHttpUrl:t=>t.startsWith("http://")||t.startsWith("https://"),formatNativeUrl(t,s){if(v.isHttpUrl(t))return this.formatUniversalUrl(t,s);let p=t;p.includes("://")||(p=t.replaceAll("/","").replaceAll(":",""),p=`${p}://`),p.endsWith("/")||(p=`${p}/`);let g=encodeURIComponent(s);return{redirect:`${p}wc?uri=${g}`,href:p}},formatUniversalUrl(t,s){if(!v.isHttpUrl(t))return this.formatNativeUrl(t,s);let p=t;p.endsWith("/")||(p=`${p}/`);let g=encodeURIComponent(s);return{redirect:`${p}wc?uri=${g}`,href:p}},openHref(t,s){window.open(t,s,"noreferrer noopener")},async preloadImage(t){let s=new Promise((s,p)=>{let g=new Image;g.onload=s,g.onerror=p,g.crossOrigin="anonymous",g.src=t});return Promise.race([s,v.wait(2e3)])},formatBalance(t,s){let p;if("0"===t)p="0.000";else if("string"==typeof t){let s=Number(t);s&&(p=s.toString().match(/^-?\d+(?:\.\d{0,3})?/u)?.[0])}return p?`${p} ${s}`:"0.000"},isRestrictedRegion(){try{let{timeZone:t}=new Intl.DateTimeFormat().resolvedOptions(),s=t.toUpperCase();return m.RESTRICTED_TIMEZONES.includes(s)}catch{return!1}},getApiUrl:()=>v.isRestrictedRegion()?"https://api.web3modal.org":"https://api.web3modal.com",getBlockchainApiUrl:()=>v.isRestrictedRegion()?"https://rpc.walletconnect.org":"https://rpc.walletconnect.com",getAnalyticsUrl:()=>v.isRestrictedRegion()?"https://pulse.walletconnect.org":"https://pulse.walletconnect.com",getUUID:()=>crypto?.randomUUID?crypto.randomUUID():"xxxxxxxx-xxxx-4xxx-yxxx-xxxxxxxxxxxx".replace(/[xy]/gu,t=>{let s=16*Math.random()|0;return("x"===t?s:3&s|8).toString(16)})},_=(0,g.sj)({isConnected:!1}),x={state:_,subscribe:t=>(0,g.Ld)(_,()=>t(_)),subscribeKey:(t,s)=>subscribeKey(_,t,s),setIsConnected(t){_.isConnected=t},setCaipAddress(t){_.caipAddress=t,_.address=t?v.getPlainAddress(t):void 0},setBalance(t,s){_.balance=t,_.balanceSymbol=s},setProfileName(t){_.profileName=t},setProfileImage(t){_.profileImage=t},setAddressExplorerUrl(t){_.addressExplorerUrl=t},resetAccount(){_.isConnected=!1,_.caipAddress=void 0,_.address=void 0,_.balance=void 0,_.balanceSymbol=void 0,_.profileName=void 0,_.profileImage=void 0,_.addressExplorerUrl=void 0}};let FetchUtil=class FetchUtil{constructor({baseUrl:t}){this.baseUrl=t}async get({headers:t,...s}){let p=this.createUrl(s),g=await fetch(p,{method:"GET",headers:t});return g.json()}async getBlob({headers:t,...s}){let p=this.createUrl(s),g=await fetch(p,{method:"GET",headers:t});return g.blob()}async post({body:t,headers:s,...p}){let g=this.createUrl(p),m=await fetch(g,{method:"POST",headers:s,body:t?JSON.stringify(t):void 0});return m.json()}async put({body:t,headers:s,...p}){let g=this.createUrl(p),m=await fetch(g,{method:"PUT",headers:s,body:t?JSON.stringify(t):void 0});return m.json()}async delete({body:t,headers:s,...p}){let g=this.createUrl(p),m=await fetch(g,{method:"DELETE",headers:s,body:t?JSON.stringify(t):void 0});return m.json()}createUrl({path:t,params:s}){let p=new URL(t,this.baseUrl);return s&&Object.entries(s).forEach(([t,s])=>{s&&p.searchParams.append(t,s)}),p}};let T="WALLETCONNECT_DEEPLINK_CHOICE",F="@w3m/recent",W={setWalletConnectDeepLink({href:t,name:s}){try{localStorage.setItem(T,JSON.stringify({href:t,name:s}))}catch{console.info("Unable to set WalletConnect deep link")}},getWalletConnectDeepLink(){try{let t=localStorage.getItem(T);if(t)return JSON.parse(t)}catch{console.info("Unable to get WalletConnect deep link")}},deleteWalletConnectDeepLink(){try{localStorage.removeItem(T)}catch{console.info("Unable to delete WalletConnect deep link")}},setWeb3ModalRecent(t){try{let s=W.getRecentWallets(),p=s.find(s=>s.id===t.id);p||(s.unshift(t),s.length>2&&s.pop(),localStorage.setItem(F,JSON.stringify(s)))}catch{console.info("Unable to set Web3Modal recent")}},getRecentWallets(){try{let t=localStorage.getItem(F);return t?JSON.parse(t):[]}catch{console.info("Unable to get Web3Modal recent")}return[]}},Z=(0,g.sj)({walletImages:{},networkImages:{},connectorImages:{},tokenImages:{}}),Q={state:Z,subscribeNetworkImages:t=>(0,g.Ld)(Z.networkImages,()=>t(Z.networkImages)),subscribeKey:(t,s)=>subscribeKey(Z,t,s),setWalletImage(t,s){Z.walletImages[t]=s},setNetworkImage(t,s){Z.networkImages[t]=s},setConnectorImage(t,s){Z.connectorImages[t]=s},setTokenImage(t,s){Z.tokenImages[t]=s}},Y=(0,g.sj)({connectors:[]}),X={state:Y,subscribeKey:(t,s)=>subscribeKey(Y,t,s),setConnectors(t){Y.connectors=t.map(t=>(0,g.iH)(t))},addConnector(t){Y.connectors.push((0,g.iH)(t))},getConnectors:()=>Y.connectors},J=(0,g.sj)({open:!1,selectedNetworkId:void 0}),en={state:J,subscribe:t=>(0,g.Ld)(J,()=>t(J)),set(t){Object.assign(J,{...J,...t})}},ei=(0,g.sj)({supportsAllNetworks:!0,isDefaultCaipNetwork:!1}),eo={state:ei,subscribeKey:(t,s)=>subscribeKey(ei,t,s),_getClient(){if(!ei._client)throw Error("NetworkController client not set");return ei._client},setClient(t){ei._client=(0,g.iH)(t)},setCaipNetwork(t){ei.caipNetwork=t,en.set({selectedNetworkId:t?.id})},setDefaultCaipNetwork(t){ei.caipNetwork=t,en.set({selectedNetworkId:t?.id}),ei.isDefaultCaipNetwork=!0},setRequestedCaipNetworks(t){ei.requestedCaipNetworks=t},async getApprovedCaipNetworksData(){let t=await this._getClient().getApprovedCaipNetworksData();ei.supportsAllNetworks=t.supportsAllNetworks,ei.approvedCaipNetworkIds=t.approvedCaipNetworkIds},async switchActiveNetwork(t){await this._getClient().switchCaipNetwork(t),ei.caipNetwork=t},resetNetwork(){ei.isDefaultCaipNetwork||(ei.caipNetwork=void 0),ei.approvedCaipNetworkIds=void 0,ei.supportsAllNetworks=!0}},ea=(0,g.sj)({projectId:"",sdkType:"w3m",sdkVersion:"html-wagmi-undefined"}),es={state:ea,subscribeKey:(t,s)=>subscribeKey(ea,t,s),setProjectId(t){ea.projectId=t},setIncludeWalletIds(t){ea.includeWalletIds=t},setExcludeWalletIds(t){ea.excludeWalletIds=t},setFeaturedWalletIds(t){ea.featuredWalletIds=t},setTokens(t){ea.tokens=t},setTermsConditionsUrl(t){ea.termsConditionsUrl=t},setPrivacyPolicyUrl(t){ea.privacyPolicyUrl=t},setCustomWallets(t){ea.customWallets=t},setEnableAnalytics(t){ea.enableAnalytics=t},setSdkVersion(t){ea.sdkVersion=t}},el=v.getApiUrl(),ec=new FetchUtil({baseUrl:el}),eu=(0,g.sj)({page:1,count:0,featured:[],recommended:[],wallets:[],search:[]}),ed={state:eu,subscribeKey:(t,s)=>subscribeKey(eu,t,s),_getApiHeaders(){let{projectId:t,sdkType:s,sdkVersion:p}=es.state;return{"x-project-id":t,"x-sdk-type":s,"x-sdk-version":p}},async _fetchWalletImage(t){let s=`${ec.baseUrl}/getWalletImage/${t}`,p=await ec.getBlob({path:s,headers:ed._getApiHeaders()});Q.setWalletImage(t,URL.createObjectURL(p))},async _fetchNetworkImage(t){let s=`${ec.baseUrl}/public/getAssetImage/${t}`,p=await ec.getBlob({path:s,headers:ed._getApiHeaders()});Q.setNetworkImage(t,URL.createObjectURL(p))},async _fetchConnectorImage(t){let s=`${ec.baseUrl}/public/getAssetImage/${t}`,p=await ec.getBlob({path:s,headers:ed._getApiHeaders()});Q.setConnectorImage(t,URL.createObjectURL(p))},async fetchNetworkImages(){let{requestedCaipNetworks:t}=eo.state,s=t?.map(({imageId:t})=>t).filter(Boolean);s&&await Promise.allSettled(s.map(t=>ed._fetchNetworkImage(t)))},async fetchConnectorImages(){let{connectors:t}=X.state,s=t.map(({imageId:t})=>t).filter(Boolean);await Promise.allSettled(s.map(t=>ed._fetchConnectorImage(t)))},async fetchFeaturedWallets(){let{featuredWalletIds:t}=es.state;if(t?.length){let{data:s}=await ec.get({path:"/getWallets",headers:ed._getApiHeaders(),params:{page:"1",entries:t?.length?String(t.length):"4",include:t?.join(",")}});s.sort((s,p)=>t.indexOf(s.id)-t.indexOf(p.id));let p=s.map(t=>t.image_id).filter(Boolean);await Promise.allSettled(p.map(t=>ed._fetchWalletImage(t))),eu.featured=s}},async fetchRecommendedWallets(){let{includeWalletIds:t,excludeWalletIds:s,featuredWalletIds:p}=es.state,g=[...s??[],...p??[]].filter(Boolean),{data:m,count:v}=await ec.get({path:"/getWallets",headers:ed._getApiHeaders(),params:{page:"1",entries:"4",include:t?.join(","),exclude:g?.join(",")}}),_=W.getRecentWallets(),x=m.map(t=>t.image_id).filter(Boolean),T=_.map(t=>t.image_id).filter(Boolean);await Promise.allSettled([...x,...T].map(t=>ed._fetchWalletImage(t))),eu.recommended=m,eu.count=v??0},async fetchWallets({page:t}){let{includeWalletIds:s,excludeWalletIds:p,featuredWalletIds:g}=es.state,m=[...eu.recommended.map(({id:t})=>t),...p??[],...g??[]].filter(Boolean),{data:_,count:x}=await ec.get({path:"/getWallets",headers:ed._getApiHeaders(),params:{page:String(t),entries:"40",include:s?.join(","),exclude:m.join(",")}}),T=_.map(t=>t.image_id).filter(Boolean);await Promise.allSettled([...T.map(t=>ed._fetchWalletImage(t)),v.wait(300)]),eu.wallets=[...eu.wallets,..._],eu.count=x>eu.count?x:eu.count,eu.page=t},async searchWallet({search:t}){let{includeWalletIds:s,excludeWalletIds:p}=es.state;eu.search=[];let{data:g}=await ec.get({path:"/getWallets",headers:ed._getApiHeaders(),params:{page:"1",entries:"100",search:t,include:s?.join(","),exclude:p?.join(",")}}),m=g.map(t=>t.image_id).filter(Boolean);await Promise.allSettled([...m.map(t=>ed._fetchWalletImage(t)),v.wait(300)]),eu.search=g},prefetch(){eu.prefetchPromise=Promise.race([Promise.allSettled([ed.fetchFeaturedWallets(),ed.fetchRecommendedWallets(),ed.fetchNetworkImages(),ed.fetchConnectorImages()]),v.wait(3e3)])}},eh=v.getAnalyticsUrl(),ef=new FetchUtil({baseUrl:eh}),ep=["MODAL_CREATED"],eg=(0,g.sj)({timestamp:Date.now(),data:{type:"track",event:"MODAL_CREATED"}}),em={state:eg,subscribe:t=>(0,g.Ld)(eg,()=>t(eg)),_getApiHeaders(){let{projectId:t,sdkType:s,sdkVersion:p}=es.state;return{"x-project-id":t,"x-sdk-type":s,"x-sdk-version":p}},async _sendAnalyticsEvent(t){try{if(ep.includes(t.data.event)||"undefined"==typeof window)return;await ef.post({path:"/e",headers:em._getApiHeaders(),body:{eventId:v.getUUID(),url:window.location.href,domain:window.location.hostname,timestamp:t.timestamp,props:t.data}})}catch{}},sendEvent(t){eg.timestamp=Date.now(),eg.data=t,es.state.enableAnalytics&&em._sendAnalyticsEvent(eg)}},eb=(0,g.sj)({view:"Connect",history:["Connect"]}),ew={state:eb,subscribeKey:(t,s)=>subscribeKey(eb,t,s),push(t,s){t!==eb.view&&(eb.view=t,eb.history.push(t),eb.data=s)},reset(t){eb.view=t,eb.history=[t]},replace(t){eb.history.length>1&&eb.history.at(-1)!==t&&(eb.view=t,eb.history[eb.history.length-1]=t)},goBack(){if(eb.history.length>1){eb.history.pop();let[t]=eb.history.slice(-1);t&&(eb.view=t)}}},ey=(0,g.sj)({open:!1}),ev={state:ey,subscribeKey:(t,s)=>subscribeKey(ey,t,s),async open(t){await ed.state.prefetchPromise,t?.view?ew.reset(t.view):x.state.isConnected?ew.reset("Account"):ew.reset("Connect"),ey.open=!0,en.set({open:!0}),em.sendEvent({type:"track",event:"MODAL_OPEN"})},close(){ey.open=!1,en.set({open:!1}),em.sendEvent({type:"track",event:"MODAL_CLOSE"})}},e_=(0,g.sj)({wcError:!1,buffering:!1}),eC={state:e_,subscribeKey:(t,s)=>subscribeKey(e_,t,s),_getClient(){if(!e_._client)throw Error("ConnectionController client not set");return e_._client},setClient(t){e_._client=(0,g.iH)(t)},connectWalletConnect(){e_.wcPromise=this._getClient().connectWalletConnect(t=>{e_.wcUri=t,e_.wcPairingExpiry=v.getPairingExpiry()})},async connectExternal(t){await this._getClient().connectExternal?.(t)},checkInstalled(t){return this._getClient().checkInstalled?.(t)},resetWcConnection(){e_.wcUri=void 0,e_.wcPairingExpiry=void 0,e_.wcPromise=void 0,e_.wcLinking=void 0,e_.recentWallet=void 0,W.deleteWalletConnectDeepLink()},setWcLinking(t){e_.wcLinking=t},setWcError(t){e_.wcError=t,e_.buffering=!1},setRecentWallet(t){e_.recentWallet=t},setBuffering(t){e_.buffering=t},async disconnect(){await this._getClient().disconnect(),this.resetWcConnection()}},ex=(0,g.sj)({message:"",variant:"success",open:!1}),eE={state:ex,subscribeKey:(t,s)=>subscribeKey(ex,t,s),showSuccess(t){ex.message=t,ex.variant="success",ex.open=!0},showError(t){ex.message=t,ex.variant="error",ex.open=!0},hide(){ex.open=!1}},ek=(0,g.sj)({themeMode:"dark",themeVariables:{}}),eS={state:ek,subscribe:t=>(0,g.Ld)(ek,()=>t(ek)),setThemeMode(t){ek.themeMode=t},setThemeVariables(t){ek.themeVariables={...ek.themeVariables,...t}}},eP=v.getBlockchainApiUrl(),eA=new FetchUtil({baseUrl:eP}),eO={fetchIdentity:({caipChainId:t,address:s})=>eA.get({path:`/v1/identity/${s}`,params:{chainId:t,projectId:es.state.projectId}})},e$={getWalletImage:t=>t?.image_url?t?.image_url:t?.image_id?Q.state.walletImages[t.image_id]:void 0,getNetworkImage:t=>t?.imageUrl?t?.imageUrl:t?.imageId?Q.state.networkImages[t.imageId]:void 0,getConnectorImage:t=>t?.imageUrl?t.imageUrl:t?.imageId?Q.state.connectorImages[t.imageId]:void 0}},74146:function(t,s,p){"use strict";var g=p(48764);"undefined"==typeof window||(window.Buffer||(window.Buffer=g.Buffer),window.global||(window.global=window),window.process||(window.process={}),window.process?.env||(window.process={env:{}}))},83756:function(t,s,p){"use strict";p.d(s,{j1:function(){return g.j1},D4:function(){return Web3ModalScaffold}});var g=p(36635),m=p(19704),v=p(77996),_=p(37380),x=p(35592),__decorate=function(t,s,p,g){var m,v=arguments.length,_=v<3?s:null===g?g=Object.getOwnPropertyDescriptor(s,p):g;if("object"==typeof Reflect&&"function"==typeof Reflect.decorate)_=Reflect.decorate(t,s,p,g);else for(var x=t.length-1;x>=0;x--)(m=t[x])&&(_=(v<3?m(_):v>3?m(s,p,_):m(s,p))||_);return v>3&&_&&Object.defineProperty(s,p,_),_};let T=class extends v.oi{constructor(){super(),this.unsubscribe=[],this.networkImages=g.WM.state.networkImages,this.disabled=!1,this.balance="show",this.address=g.AccountController.state.address,this.balanceVal=g.AccountController.state.balance,this.balanceSymbol=g.AccountController.state.balanceSymbol,this.profileName=g.AccountController.state.profileName,this.profileImage=g.AccountController.state.profileImage,this.network=g.NetworkController.state.caipNetwork,this.unsubscribe.push(...[g.AccountController.subscribe(t=>{t.isConnected?(this.address=t.address,this.balanceVal=t.balance,this.profileName=t.profileName,this.profileImage=t.profileImage,this.balanceSymbol=t.balanceSymbol):(this.address="",this.balanceVal="",this.profileName="",this.profileImage="",this.balanceSymbol="")}),g.NetworkController.subscribeKey("caipNetwork",t=>this.network=t)])}disconnectedCallback(){this.unsubscribe.forEach(t=>t())}render(){let t=this.networkImages[this.network?.imageId??""],s="show"===this.balance;return v.dy`
    ...
    `}onClick(){this.open?g.IN.close():g.IN.open()}};w3m_connect_button_decorate([(0,_.Cb)()],W.prototype,"size",void 0),w3m_connect_button_decorate([(0,_.Cb)()],W.prototype,"label",void 0),w3m_connect_button_decorate([(0,_.Cb)()],W.prototype,"loadingLabel",void 0),w3m_connect_button_decorate([(0,_.SB)()],W.prototype,"open",void 0),W=w3m_connect_button_decorate([(0,m.customElement)("w3m-connect-button")],W),p(90078);var w3m_network_button_decorate=function(t,s,p,g){var m,v=arguments.length,_=v<3?s:null===g?g=Object.getOwnPropertyDescriptor(s,p):g;if("object"==typeof Reflect&&"function"==typeof Reflect.decorate)_=Reflect.decorate(t,s,p,g);else for(var x=t.length-1;x>=0;x--)(m=t[x])&&(_=(v<3?m(_):v>3?m(s,p,_):m(s,p))||_);return v>3&&_&&Object.defineProperty(s,p,_),_};let Z=class extends v.oi{constructor(){super(),this.unsubscribe=[],this.disabled=!1,this.network=g.NetworkController.state.caipNetwork,this.connected=g.AccountController.state.isConnected,this.unsubscribe.push(...[g.NetworkController.subscribeKey("caipNetwork",t=>this.network=t),g.AccountController.subscribeKey("isConnected",t=>this.connected=t)])}disconnectedCallback(){this.unsubscribe.forEach(t=>t())}render(){return v.dy`
      <wui-network-button
        .disabled=${!!this.disabled}
        imageSrc=${(0,x.o)(g.fz.getNetworkImage(this.network))}
        @click=${this.onClick.bind(this)}
      >
        ${this.network?.name??(this.connected?"Unknown Network":"Select Network")}
      </wui-network-button>
    `}onClick(){g.IN.open({view:"Networks"})}};w3m_network_button_decorate([(0,_.Cb)({type:Boolean})],Z.prototype,"disabled",void 0),w3m_network_button_decorate([(0,_.SB)()],Z.prototype,"network",void 0),w3m_network_button_decorate([(0,_.SB)()],Z.prototype,"connected",void 0),Z=w3m_network_button_decorate([(0,m.customElement)("w3m-network-button")],Z);var Q=v.iv`
  :host {
    display: block;
    will-change: transform, opacity;
  }
`,w3m_router_decorate=function(t,s,p,g){var m,v=arguments.length,_=v<3?s:null===g?g=Object.getOwnPropertyDescriptor(s,p):g;if("object"==typeof Reflect&&"function"==typeof Reflect.decorate)_=Reflect.decorate(t,s,p,g);else for(var x=t.length-1;x>=0;x--)(m=t[x])&&(_=(v<3?m(_):v>3?m(s,p,_):m(s,p))||_);return v>3&&_&&Object.defineProperty(s,p,_),_};let Y=class extends v.oi{constructor(){super(),this.resizeObserver=void 0,this.prevHeight="0px",this.prevHistoryLength=1,this.unsubscribe=[],this.view=g.RouterController.state.view,this.unsubscribe.push(g.RouterController.subscribeKey("view",t=>this.onViewChange(t)))}firstUpdated(){this.resizeObserver=new ResizeObserver(async([t])=>{let s=`${t?.contentRect.height}px`;"0px"!==this.prevHeight&&(await this.animate([{height:this.prevHeight},{height:s}],{duration:150,easing:"ease",fill:"forwards"}).finished,this.style.height="auto"),this.prevHeight=s}),this.resizeObserver.observe(this.getWrapper())}disconnectedCallback(){this.resizeObserver?.unobserve(this.getWrapper()),this.unsubscribe.forEach(t=>t())}render(){return v.dy`<div>${this.viewTemplate()}</div>`}viewTemplate(){switch(this.view){case"Connect":default:return v.dy`<w3m-connect-view></w3m-connect-view>`;case"ConnectingWalletConnect":return v.dy`<w3m-connecting-wc-view></w3m-connecting-wc-view>`;case"ConnectingExternal":return v.dy`<w3m-connecting-external-view></w3m-connecting-external-view>`;case"AllWallets":return v.dy`<w3m-all-wallets-view></w3m-all-wallets-view>`;case"Networks":return v.dy`<w3m-networks-view></w3m-networks-view>`;case"SwitchNetwork":return v.dy`<w3m-network-switch-view></w3m-network-switch-view>`;case"Account":return v.dy`<w3m-account-view></w3m-account-view>`;case"WhatIsAWallet":return v.dy`<w3m-what-is-a-wallet-view></w3m-what-is-a-wallet-view>`;case"WhatIsANetwork":return v.dy`<w3m-what-is-a-network-view></w3m-what-is-a-network-view>`;case"GetWallet":return v.dy`<w3m-get-wallet-view></w3m-get-wallet-view>`;case"Downloads":return v.dy`<w3m-downloads-view></w3m-downloads-view>`}}async onViewChange(t){let{history:s}=g.RouterController.state,p=-10,m=10;s.length<this.prevHistoryLength&&(p=10,m=-10),this.prevHistoryLength=s.length,await this.animate([{opacity:1,transform:"translateX(0px)"},{opacity:0,transform:`translateX(${p}px)`}],{duration:150,easing:"ease",fill:"forwards"}).finished,this.view=t,await this.animate([{opacity:0,transform:`translateX(${m}px)`},{opacity:1,transform:"translateX(0px)"}],{duration:150,easing:"ease",fill:"forwards",delay:50}).finished}getWrapper(){return this.shadowRoot?.querySelector("div")}};Y.styles=Q,w3m_router_decorate([(0,_.SB)()],Y.prototype,"view",void 0),Y=w3m_router_decorate([(0,m.customElement)("w3m-router")],Y);var X=v.iv`
  wui-flex {
    width: 100%;
  }
...
`,w3m_account_view_decorate=function(t,s,p,g){var m,v=arguments.length,_=v<3?s:null===g?g=Object.getOwnPropertyDescriptor(s,p):g;if("object"==typeof Reflect&&"function"==typeof Reflect.decorate)_=Reflect.decorate(t,s,p,g);else for(var x=t.length-1;x>=0;x--)(m=t[x])&&(_=(v<3?m(_):v>3?m(s,p,_):m(s,p))||_);return v>3&&_&&Object.defineProperty(s,p,_),_};let J=class extends v.oi{constructor(){super(),this.usubscribe=[],this.networkImages=g.WM.state.networkImages,this.address=g.AccountController.state.address,this.profileImage=g.AccountController.state.profileImage,this.profileName=g.AccountController.state.profileName,this.balance=g.AccountController.state.balance,this.balanceSymbol=g.AccountController.state.balanceSymbol,this.network=g.NetworkController.state.caipNetwork,this.disconecting=!1,this.usubscribe.push(...[g.AccountController.subscribe(t=>{t.address?(this.address=t.address,this.profileImage=t.profileImage,this.profileName=t.profileName,this.balance=t.balance,this.balanceSymbol=t.balanceSymbol):g.IN.close()})],g.NetworkController.subscribeKey("caipNetwork",t=>{t?.id&&(this.network=t)}))}disconnectedCallback(){this.usubscribe.forEach(t=>t())}render(){if(!this.address)throw Error("w3m-account-view: No account provided");let t=this.networkImages[this.network?.imageId??""];return v.dy`
      <wui-flex
      ...
      >
        <wui-avatar
          ...
          imageSrc=${(0,x.o)(this.profileImage)}
        ></wui-avatar>

        <wui-flex flexDirection="column" alignItems="center">
          <wui-flex gap="3xs" alignItems="center" justifyContent="center">
            <wui-text variant="large-600" color="fg-100">
              ${this.profileName?m.UiHelperUtil.getTruncateString({string:this.profileName,charsStart:20,charsEnd:0,truncate:"end"}):m.UiHelperUtil.getTruncateString({string:this.address,charsStart:4,charsEnd:6,truncate:"middle"})}
            </wui-text>
            <wui-icon-link
              size="md"
              icon="copy"
          ...
          <wui-flex gap="s" flexDirection="column" alignItems="center">
            <wui-text variant="paragraph-500" color="fg-200">
              ${g.j1.formatBalance(this.balance,this.balanceSymbol)}
            </wui-text>
    ...
    `}explorerBtnTemplate(){let{addressExplorerUrl:t}=g.AccountController.state;return t?v.dy`
      <wui-button size="sm" variant="shade" @click=${this.onExplorer.bind(this)}>
        <wui-icon size="sm" color="inherit" slot="iconLeft" name="compass"></wui-icon>
        Block Explorer
        <wui-icon size="sm" color="inherit" slot="iconRight" name="externalLink"></wui-icon>
      </wui-button>
    `:null}isAllowedNetworkSwitch(){let{requestedCaipNetworks:t}=g.NetworkController.state,s=!!t&&t.length>1,p=t?.find(({id:t})=>t===this.network?.id);return s||!p}onCopyAddress(){try{this.address&&(g.j1.copyToClopboard(this.address),g.SnackController.showSuccess("Address copied"))}catch{g.SnackController.showError("Failed to copy")}}onNetworks(){this.isAllowedNetworkSwitch()&&g.RouterController.push("Networks")}async onDisconnect(){try{this.disconecting=!0,await g.ConnectionController.disconnect(),g.Xs.sendEvent({type:"track",event:"DISCONNECT_SUCCESS"}),g.IN.close()}catch{g.Xs.sendEvent({type:"track",event:"DISCONNECT_ERROR"}),g.SnackController.showError("Failed to disconnect")}finally{this.disconecting=!1}}onExplorer(){let{addressExplorerUrl:t}=g.AccountController.state;t&&g.j1.openHref(t,"_blank")}};J.styles=X,w3m_account_view_decorate([(0,_.SB)()],J.prototype,"address",void 0),w3m_account_view_decorate([(0,_.SB)()],J.prototype,"profileImage",void 0),w3m_account_view_decorate([(0,_.SB)()],J.prototype,"profileName",void 0),w3m_account_view_decorate([(0,_.SB)()],J.prototype,"balance",void 0),w3m_account_view_decorate([(0,_.SB)()],J.prototype,"balanceSymbol",void 0),w3m_account_view_decorate([(0,_.SB)()],J.prototype,"network",void 0),w3m_account_view_decorate([(0,_.SB)()],J.prototype,"disconecting",void 0),J=w3m_account_view_decorate([(0,m.customElement)("w3m-account-view")],J);var w3m_all_wallets_view_decorate=function(t,s,p,g){var m,v=arguments.length,_=v<3?s:null===g?g=Object.getOwnPropertyDescriptor(s,p):g;if("object"==typeof Reflect&&"function"==typeof Reflect.decorate)_=Reflect.decorate(t,s,p,g);else for(var x=t.length-1;x>=0;x--)(m=t[x])&&(_=(v<3?m(_):v>3?m(s,p,_):m(s,p))||_);return v>3&&_&&Object.defineProperty(s,p,_),_};let en=class extends v.oi{constructor(){super(...arguments),this.search="",this.onDebouncedSearch=g.j1.debounce(t=>{this.search=t})}render(){let t=this.search.length>=2;return v.dy`
      <wui-flex padding="s" gap="s">
        <wui-search-bar @inputChange=${this.onInputChange.bind(this)}></wui-search-bar>
        ${this.qrButtonTemplate()}
      </wui-flex>
      ${t?v.dy`<w3m-all-wallets-search query=${this.search}></w3m-all-wallets-search>`:v.dy`<w3m-all-wallets-list></w3m-all-wallets-list>`}
    `}onInputChange(t){this.onDebouncedSearch(t.detail)}qrButtonTemplate(){return g.j1.isMobile()?v.dy`
        <wui-icon-box
          size="lg"
        ...
        ></wui-icon-box>
      `:null}onWalletConnectQr(){g.RouterController.push("ConnectingWalletConnect")}};w3m_all_wallets_view_decorate([(0,_.SB)()],en.prototype,"search",void 0),en=w3m_all_wallets_view_decorate([(0,m.customElement)("w3m-all-wallets-view")],en);var ei=v.iv`
  wui-flex {
...
`,w3m_connect_view_decorate=function(t,s,p,g){var m,v=arguments.length,_=v<3?s:null===g?g=Object.getOwnPropertyDescriptor(s,p):g;if("object"==typeof Reflect&&"function"==typeof Reflect.decorate)_=Reflect.decorate(t,s,p,g);else for(var x=t.length-1;x>=0;x--)(m=t[x])&&(_=(v<3?m(_):v>3?m(s,p,_):m(s,p))||_);return v>3&&_&&Object.defineProperty(s,p,_),_};let eo=class extends v.oi{constructor(){super(),this.unsubscribe=[],this.connectors=g.ConnectorController.state.connectors,this.unsubscribe.push(g.ConnectorController.subscribeKey("connectors",t=>this.connectors=t))}disconnectedCallback(){this.unsubscribe.forEach(t=>t())}render(){return v.dy`
    ...
    `}walletConnectConnectorTemplate(){if(g.j1.isMobile())return null;let t=this.connectors.find(t=>"WALLET_CONNECT"===t.type);return t?v.dy`
      <wui-list-wallet
        imageSrc=${(0,x.o)(g.fz.getConnectorImage(t))}
        name=${t.name??"Unknown"}
    ...
    `:null}customTemplate(){let{customWallets:t}=g.OptionsController.state;if(!t?.length)return null;let s=this.filterOutDuplicateWallets(t);return s.map(t=>v.dy`
        <wui-list-wallet
          imageSrc=${(0,x.o)(g.fz.getWalletImage(t))}
          name=${t.name??"Unknown"}
          @click=${()=>this.onConnectWallet(t)}
        >
        </wui-list-wallet>
      `)}featuredTemplate(){let{featured:t}=g.ApiController.state;if(!t.length)return null;let s=this.filterOutDuplicateWallets(t);return s.map(t=>v.dy`
        <wui-list-wallet
          imageSrc=${(0,x.o)(g.fz.getWalletImage(t))}
          name=${t.name??"Unknown"}
          @click=${()=>this.onConnectWallet(t)}
      ...
      `)}recentTemplate(){let t=g.MO.getRecentWallets();return t.map(t=>v.dy`
        <wui-list-wallet
          imageSrc=${(0,x.o)(g.fz.getWalletImage(t))}
          name=${t.name??"Unknown"}
          @click=${()=>this.onConnectWallet(t)}
      ...
      `)}announcedTemplate(){return this.connectors.map(t=>"ANNOUNCED"!==t.type?null:v.dy`
        <wui-list-wallet
          imageSrc=${(0,x.o)(g.fz.getConnectorImage(t))}
          name=${t.name??"Unknown"}
          @click=${()=>this.onConnector(t)}
      ...
      `)}injectedTemplate(){let t=this.connectors.find(t=>"ANNOUNCED"===t.type);return this.connectors.map(s=>"INJECTED"===s.type&&g.ConnectionController.checkInstalled()?v.dy`
        <wui-list-wallet
          imageSrc=${(0,x.o)(g.fz.getConnectorImage(s))}
          name=${s.name??"Unknown"}
          @click=${()=>this.onConnector(s)}
          tagLabel=${(0,x.o)(t?void 0:"installed")}
          tagVariant=${(0,x.o)(t?void 0:"success")}
        >
        </wui-list-wallet>
      `:null)}connectorsTemplate(){return this.connectors.map(t=>["WALLET_CONNECT","INJECTED","ANNOUNCED"].includes(t.type)?null:v.dy`
        <wui-list-wallet
          imageSrc=${(0,x.o)(g.fz.getConnectorImage(t))}
          name=${t.name??"Unknown"}
          @click=${()=>this.onConnector(t)}
      ...
      `)}allWalletsTemplate(){let t=10*Math.floor(g.ApiController.state.count/10);return v.dy`
      <wui-list-wallet
        name="All Wallets"
        ...
        tagVariant="shade"
      ></wui-list-wallet>
    `}recommendedTemplate(){let{recommended:t}=g.ApiController.state,{customWallets:s,featuredWalletIds:p}=g.OptionsController.state,{connectors:m}=g.ConnectorController.state,_=g.MO.getRecentWallets(),T=m.filter(t=>"ANNOUNCED"===t.type);if(p||s||!t.length)return null;let F=T.length+_.length,W=this.filterOutDuplicateWallets(t).slice(0,Math.max(0,2-F));return W.map(t=>v.dy`
        <wui-list-wallet
          imageSrc=${(0,x.o)(g.fz.getWalletImage(t))}
          name=${t?.name??"Unknown"}
          @click=${()=>this.onConnectWallet(t)}
      ...
      `)}onConnector(t){"WALLET_CONNECT"===t.type?g.j1.isMobile()?g.RouterController.push("AllWallets"):g.RouterController.push("ConnectingWalletConnect"):g.RouterController.push("ConnectingExternal",{connector:t})}filterOutDuplicateWallets(t){let{connectors:s}=g.ConnectorController.state,p=g.MO.getRecentWallets(),m=p.map(t=>t.id),v=s.map(t=>t.info?.rdns).filter(Boolean),_=t.filter(t=>!m.includes(t.id)&&!v.includes(t.rdns??void 0));return _}onAllWallets(){g.Xs.sendEvent({type:"track",event:"CLICK_ALL_WALLETS"}),g.RouterController.push("AllWallets")}onConnectWallet(t){g.RouterController.push("ConnectingWalletConnect",{wallet:t})}};eo.styles=ei,w3m_connect_view_decorate([(0,_.SB)()],eo.prototype,"connectors",void 0),eo=w3m_connect_view_decorate([(0,m.customElement)("w3m-connect-view")],eo);var ea=v.iv`
  @keyframes shake {
    0% {
...
`,w3m_connecting_widget_decorate=function(t,s,p,g){var m,v=arguments.length,_=v<3?s:null===g?g=Object.getOwnPropertyDescriptor(s,p):g;if("object"==typeof Reflect&&"function"==typeof Reflect.decorate)_=Reflect.decorate(t,s,p,g);else for(var x=t.length-1;x>=0;x--)(m=t[x])&&(_=(v<3?m(_):v>3?m(s,p,_):m(s,p))||_);return v>3&&_&&Object.defineProperty(s,p,_),_};let W3mConnectingWidget=class W3mConnectingWidget extends v.oi{constructor(){super(),this.wallet=g.RouterController.state.data?.wallet,this.connector=g.RouterController.state.data?.connector,this.timeout=void 0,this.secondaryBtnLabel="Try again",this.secondaryBtnIcon="refresh",this.secondaryLabel="Accept connection request in the wallet",this.onConnect=void 0,this.onRender=void 0,this.onAutoConnect=void 0,this.isWalletConnect=!0,this.unsubscribe=[],this.imageSrc=g.fz.getWalletImage(this.wallet)??g.fz.getConnectorImage(this.connector),this.name=this.wallet?.name??this.connector?.name??"Wallet",this.isRetrying=!1,this.uri=g.ConnectionController.state.wcUri,this.error=g.ConnectionController.state.wcError,this.ready=!1,this.showRetry=!1,this.buffering=!1,this.isMobile=!1,this.onRetry=void 0,this.unsubscribe.push(...[g.ConnectionController.subscribeKey("wcUri",t=>{this.uri=t,this.isRetrying&&this.onRetry&&(this.isRetrying=!1,this.onConnect?.())}),g.ConnectionController.subscribeKey("wcError",t=>this.error=t),g.ConnectionController.subscribeKey("buffering",t=>this.buffering=t)])}firstUpdated(){this.onAutoConnect?.(),this.showRetry=!this.onAutoConnect}disconnectedCallback(){this.unsubscribe.forEach(t=>t()),clearTimeout(this.timeout)}render(){this.onRender?.(),this.onShowRetry();let t=this.error?"Connection can be declined if a previous request is still active":this.secondaryLabel,s=`Continue in ${this.name}`;return this.buffering&&(s="Connecting..."),this.error&&(s="Connection declined"),v.dy`
      <wui-flex
        data-error=${(0,x.o)(this.error)}
      ...
      >
        <wui-flex justifyContent="center" alignItems="center">
          <wui-wallet-image size="lg" imageSrc=${(0,x.o)(this.imageSrc)}></wui-wallet-image>
    ...
    `}onShowRetry(){if(this.error&&!this.showRetry){this.showRetry=!0;let t=this.shadowRoot?.querySelector("wui-button");t.animate([{opacity:0},{opacity:1}],{fill:"forwards",easing:"ease"})}}onTryAgain(){this.buffering||(g.ConnectionController.setWcError(!1),this.onRetry?(this.isRetrying=!0,this.onRetry?.()):this.onConnect?.())}loaderTemplate(){let t=g.ThemeController.state.themeVariables["--w3m-border-radius-master"],s=t?parseInt(t.replace("px",""),10):4;return v.dy`<wui-loading-thumbnail radius=${9*s}></wui-loading-thumbnail>`}onCopyUri(){try{this.uri&&(g.j1.copyToClopboard(this.uri),g.SnackController.showSuccess("Link copied"))}catch{g.SnackController.showError("Failed to copy")}}};W3mConnectingWidget.styles=ea,w3m_connecting_widget_decorate([(0,_.SB)()],W3mConnectingWidget.prototype,"uri",void 0),w3m_connecting_widget_decorate([(0,_.SB)()],W3mConnectingWidget.prototype,"error",void 0),w3m_connecting_widget_decorate([(0,_.SB)()],W3mConnectingWidget.prototype,"ready",void 0),w3m_connecting_widget_decorate([(0,_.SB)()],W3mConnectingWidget.prototype,"showRetry",void 0),w3m_connecting_widget_decorate([(0,_.SB)()],W3mConnectingWidget.prototype,"buffering",void 0),w3m_connecting_widget_decorate([(0,_.Cb)({type:Boolean})],W3mConnectingWidget.prototype,"isMobile",void 0),w3m_connecting_widget_decorate([(0,_.Cb)()],W3mConnectingWidget.prototype,"onRetry",void 0);let es={INJECTED:"browser",ANNOUNCED:"browser"},el=class extends W3mConnectingWidget{constructor(){if(super(),!this.connector)throw Error("w3m-connecting-view: No connector provided");g.Xs.sendEvent({type:"track",event:"SELECT_WALLET",properties:{name:this.connector.name??"Unknown",platform:es[this.connector.type]??"external"}}),this.onConnect=this.onConnectProxy.bind(this),this.onAutoConnect=this.onConnectProxy.bind(this),this.isWalletConnect=!1}async onConnectProxy(){try{this.error=!1,this.connector&&(await g.ConnectionController.connectExternal(this.connector),g.IN.close(),g.Xs.sendEvent({type:"track",event:"CONNECT_SUCCESS",properties:{method:"external"}}))}catch(t){g.Xs.sendEvent({type:"track",event:"CONNECT_ERROR",properties:{message:t?.message??"Unknown"}}),this.error=!0}}};el=function(t,s,p,g){var m,v=arguments.length,_=v<3?s:null===g?g=Object.getOwnPropertyDescriptor(s,p):g;if("object"==typeof Reflect&&"function"==typeof Reflect.decorate)_=Reflect.decorate(t,s,p,g);else for(var x=t.length-1;x>=0;x--)(m=t[x])&&(_=(v<3?m(_):v>3?m(s,p,_):m(s,p))||_);return v>3&&_&&Object.defineProperty(s,p,_),_}([(0,m.customElement)("w3m-connecting-external-view")],el);var w3m_connecting_wc_view_decorate=function(t,s,p,g){var m,v=arguments.length,_=v<3?s:null===g?g=Object.getOwnPropertyDescriptor(s,p):g;if("object"==typeof Reflect&&"function"==typeof Reflect.decorate)_=Reflect.decorate(t,s,p,g);else for(var x=t.length-1;x>=0;x--)(m=t[x])&&(_=(v<3?m(_):v>3?m(s,p,_):m(s,p))||_);return v>3&&_&&Object.defineProperty(s,p,_),_};let ec=class extends v.oi{constructor(){super(),this.interval=void 0,this.lastRetry=Date.now(),this.wallet=g.RouterController.state.data?.wallet,this.platform=void 0,this.platforms=[],this.initializeConnection(),this.interval=setInterval(this.initializeConnection.bind(this),g.bq.TEN_SEC_MS)}disconnectedCallback(){clearTimeout(this.interval)}render(){return this.wallet?(this.determinePlatforms(),v.dy`
      ${this.headerTemplate()}
      <div>${this.platformTemplate()}</div>
    `):v.dy`<w3m-connecting-wc-qrcode></w3m-connecting-wc-qrcode>`}async initializeConnection(t=!1){try{let{wcPairingExpiry:s}=g.ConnectionController.state;(t||g.j1.isPairingExpired(s))&&(g.ConnectionController.connectWalletConnect(),await g.ConnectionController.state.wcPromise,this.finalizeConnection(),g.IN.close())}catch(t){g.Xs.sendEvent({type:"track",event:"CONNECT_ERROR",properties:{message:t?.message??"Unknown"}}),g.ConnectionController.setWcError(!0),g.j1.isAllowedRetry(this.lastRetry)&&(g.SnackController.showError("Declined"),this.lastRetry=Date.now(),this.initializeConnection(!0))}}finalizeConnection(){let{wcLinking:t,recentWallet:s}=g.ConnectionController.state;t&&g.MO.setWalletConnectDeepLink(t),s&&g.MO.setWeb3ModalRecent(s),g.Xs.sendEvent({type:"track",event:"CONNECT_SUCCESS",properties:{method:t?"mobile":"qrcode"}})}determinePlatforms(){if(!this.wallet)throw Error("w3m-connecting-wc-view:determinePlatforms No wallet");if(this.platform)return;let{mobile_link:t,desktop_link:s,webapp_link:p,injected:m,rdns:v}=this.wallet,_=m?.map(({injected_id:t})=>t).filter(Boolean),x=v?[v]:_??[],T=x.length,F=g.ConnectionController.checkInstalled(x),W=T&&F,Z=s&&!g.j1.isMobile();W&&this.platforms.push("browser"),t&&this.platforms.push(g.j1.isMobile()?"mobile":"qrcode"),p&&this.platforms.push("web"),Z&&this.platforms.push("desktop"),!W&&T&&this.platforms.push("unsupported"),this.platform=this.platforms[0]}platformTemplate(){switch(this.platform){case"browser":return v.dy`<w3m-connecting-wc-browser></w3m-connecting-wc-browser>`;case"desktop":return v.dy`
          <w3m-connecting-wc-desktop .onRetry=${()=>this.initializeConnection(!0)}>
          </w3m-connecting-wc-desktop>
        `;case"web":return v.dy`
          <w3m-connecting-wc-web .onRetry=${()=>this.initializeConnection(!0)}>
          </w3m-connecting-wc-web>
        `;case"mobile":return v.dy`
          <w3m-connecting-wc-mobile isMobile .onRetry=${()=>this.initializeConnection(!0)}>
          </w3m-connecting-wc-mobile>
        `;case"qrcode":return v.dy`<w3m-connecting-wc-qrcode></w3m-connecting-wc-qrcode>`;default:return v.dy`<w3m-connecting-wc-unsupported></w3m-connecting-wc-unsupported>`}}headerTemplate(){let t=this.platforms.length>1;return t?v.dy`
      <w3m-connecting-header
        .platforms=${this.platforms}
        .onSelectPlatfrom=${this.onSelectPlatform.bind(this)}
      >
      </w3m-connecting-header>
    `:null}async onSelectPlatform(t){let s=this.shadowRoot?.querySelector("div");s&&(await s.animate([{opacity:1},{opacity:0}],{duration:200,fill:"forwards",easing:"ease"}).finished,this.platform=t,s.animate([{opacity:0},{opacity:1}],{duration:200,fill:"forwards",easing:"ease"}))}};w3m_connecting_wc_view_decorate([(0,_.SB)()],ec.prototype,"platform",void 0),w3m_connecting_wc_view_decorate([(0,_.SB)()],ec.prototype,"platforms",void 0),ec=w3m_connecting_wc_view_decorate([(0,m.customElement)("w3m-connecting-wc-view")],ec);let eu=class extends v.oi{constructor(){super(...arguments),this.wallet=g.RouterController.state.data?.wallet}render(){if(!this.wallet)throw Error("w3m-downloads-view");return v.dy`
      <wui-flex gap="xs" flexDirection="column" .padding=${["s","s","l","s"]}>
        ${this.chromeTemplate()} ${this.iosTemplate()} ${this.androidTemplate()}
        ${this.homepageTemplate()}
      </wui-flex>
    `}chromeTemplate(){return this.wallet?.chrome_store?v.dy`<wui-list-item
      variant="icon"
      icon="chromeStore"
      iconVariant="square"
    ...
    </wui-list-item>`:null}iosTemplate(){return this.wallet?.app_store?v.dy`<wui-list-item
      variant="icon"
      icon="appStore"
      iconVariant="square"
    ...
    </wui-list-item>`:null}androidTemplate(){return this.wallet?.play_store?v.dy`<wui-list-item
      variant="icon"
      icon="playStore"
      iconVariant="square"
    ...
    </wui-list-item>`:null}homepageTemplate(){return this.wallet?.homepage?v.dy`
      <wui-list-item
        variant="icon"
        icon="browser"
    ...
    `:null}onChromeStore(){this.wallet?.chrome_store&&g.j1.openHref(this.wallet.chrome_store,"_blank")}onAppStore(){this.wallet?.app_store&&g.j1.openHref(this.wallet.app_store,"_blank")}onPlayStore(){this.wallet?.play_store&&g.j1.openHref(this.wallet.play_store,"_blank")}onHomePage(){this.wallet?.homepage&&g.j1.openHref(this.wallet.homepage,"_blank")}};eu=function(t,s,p,g){var m,v=arguments.length,_=v<3?s:null===g?g=Object.getOwnPropertyDescriptor(s,p):g;if("object"==typeof Reflect&&"function"==typeof Reflect.decorate)_=Reflect.decorate(t,s,p,g);else for(var x=t.length-1;x>=0;x--)(m=t[x])&&(_=(v<3?m(_):v>3?m(s,p,_):m(s,p))||_);return v>3&&_&&Object.defineProperty(s,p,_),_}([(0,m.customElement)("w3m-downloads-view")],eu);let ed=class extends v.oi{render(){return v.dy`
      <wui-flex flexDirection="column" padding="s" gap="xs">
        ...
        <wui-list-wallet
          ...
          walletIcon="allWallets"
          icon="externalLink"
          @click=${()=>{g.j1.openHref("https://walletconnect.com/explorer?type=wallet","_blank")}}
        ></wui-list-wallet>
      </wui-flex>
    `}recommendedWalletsTemplate(){let{recommended:t,featured:s}=g.ApiController.state,{customWallets:p}=g.OptionsController.state,m=[...s,...p??[],...t].slice(0,4);return m.map(t=>v.dy`
        <wui-list-wallet
          name=${t.name??"Unknown"}
          tagVariant="main"
          imageSrc=${(0,x.o)(g.fz.getWalletImage(t))}
          @click=${()=>{g.j1.openHref(t.homepage??"https://walletconnect.com/explorer","_blank")}}
        ></wui-list-wallet>
      `)}};ed=function(t,s,p,g){var m,v=arguments.length,_=v<3?s:null===g?g=Object.getOwnPropertyDescriptor(s,p):g;if("object"==typeof Reflect&&"function"==typeof Reflect.decorate)_=Reflect.decorate(t,s,p,g);else for(var x=t.length-1;x>=0;x--)(m=t[x])&&(_=(v<3?m(_):v>3?m(s,p,_):m(s,p))||_);return v>3&&_&&Object.defineProperty(s,p,_),_}([(0,m.customElement)("w3m-get-wallet-view")],ed);var eh=v.iv`
  @keyframes shake {
    0% {
      transform: translateX(0);
    }
...
`,w3m_network_switch_view_decorate=function(t,s,p,g){var m,v=arguments.length,_=v<3?s:null===g?g=Object.getOwnPropertyDescriptor(s,p):g;if("object"==typeof Reflect&&"function"==typeof Reflect.decorate)_=Reflect.decorate(t,s,p,g);else for(var x=t.length-1;x>=0;x--)(m=t[x])&&(_=(v<3?m(_):v>3?m(s,p,_):m(s,p))||_);return v>3&&_&&Object.defineProperty(s,p,_),_};let ef=class extends v.oi{constructor(){super(),this.network=g.RouterController.state.data?.network,this.unsubscribe=[],this.showRetry=!1,this.error=!1,this.currentNetwork=g.NetworkController.state.caipNetwork,this.unsubscribe.push(g.NetworkController.subscribeKey("caipNetwork",t=>{t?.id!==this.currentNetwork?.id&&g.RouterController.goBack()}))}disconnectedCallback(){this.unsubscribe.forEach(t=>t())}firstUpdated(){this.onSwitchNetwork()}render(){if(!this.network)throw Error("w3m-network-switch-view: No network provided");this.onShowRetry();let t=this.error?"Switch declined":"Approve in wallet",s=this.error?"Switch can be declined if chain is not supported by a wallet or previous request is still active":"Accept connection request in your wallet";return v.dy`
      <wui-flex
      ...
      >
        <wui-flex justifyContent="center" alignItems="center">
          ...
          ${this.error?null:v.dy`<wui-loading-hexagon></wui-loading-hexagon>`}
    ...
    `}onShowRetry(){if(this.error&&!this.showRetry){this.showRetry=!0;let t=this.shadowRoot?.querySelector("wui-button");t.animate([{opacity:0},{opacity:1}],{fill:"forwards",easing:"ease"})}}async onSwitchNetwork(){try{this.error=!1,this.network&&(await g.NetworkController.switchActiveNetwork(this.network),g.RouterController.goBack())}catch{this.error=!0}}};ef.styles=eh,w3m_network_switch_view_decorate([(0,_.SB)()],ef.prototype,"showRetry",void 0),w3m_network_switch_view_decorate([(0,_.SB)()],ef.prototype,"error",void 0),w3m_network_switch_view_decorate([(0,_.SB)()],ef.prototype,"currentNetwork",void 0),ef=w3m_network_switch_view_decorate([(0,m.customElement)("w3m-network-switch-view")],ef);var w3m_networks_view_decorate=function(t,s,p,g){var m,v=arguments.length,_=v<3?s:null===g?g=Object.getOwnPropertyDescriptor(s,p):g;if("object"==typeof Reflect&&"function"==typeof Reflect.decorate)_=Reflect.decorate(t,s,p,g);else for(var x=t.length-1;x>=0;x--)(m=t[x])&&(_=(v<3?m(_):v>3?m(s,p,_):m(s,p))||_);return v>3&&_&&Object.defineProperty(s,p,_),_};let ep=class extends v.oi{constructor(){super(),this.unsubscribe=[],this.caipNetwork=g.NetworkController.state.caipNetwork,this.unsubscribe.push(g.NetworkController.subscribeKey("caipNetwork",t=>this.caipNetwork=t))}disconnectedCallback(){this.unsubscribe.forEach(t=>t())}render(){return v.dy`
    ...
    `}onNetworkHelp(){g.Xs.sendEvent({type:"track",event:"CLICK_NETWORK_HELP"}),g.RouterController.push("WhatIsANetwork")}networksTemplate(){let{approvedCaipNetworkIds:t,requestedCaipNetworks:s,supportsAllNetworks:p}=g.NetworkController.state;return t?.length&&s?.sort((s,p)=>t.indexOf(p.id)-t.indexOf(s.id)),s?.map(s=>v.dy`
        <wui-card-select
          .selected=${this.caipNetwork?.id===s.id}
          imageSrc=${x.o(g.fz.getNetworkImage(s))}
          type="network"
          name=${s.name??s.id}
          @click=${()=>this.onSwitchNetwork(s)}
          .disabled=${!p&&!t?.includes(s.id)}
        ></wui-card-select>
      `)}async onSwitchNetwork(t){let{isConnected:s}=g.AccountController.state,{approvedCaipNetworkIds:p,supportsAllNetworks:m,caipNetwork:v}=g.NetworkController.state;s&&v?.id!==t.id?p?.includes(t.id)?await g.NetworkController.switchActiveNetwork(t):m&&g.RouterController.push("SwitchNetwork",{network:t}):s||(g.NetworkController.setCaipNetwork(t),g.RouterController.push("Connect"))}};w3m_networks_view_decorate([(0,_.SB)()],ep.prototype,"caipNetwork",void 0),ep=w3m_networks_view_decorate([(0,m.customElement)("w3m-networks-view")],ep);let eg=[{images:["network","layers","system"],title:"The system’s nuts and bolts",text:"A network is what brings the blockchain to life, as this technical infrastructure allows apps to access the ledger and smart contract services."},{images:["noun","defiAlt","dao"],title:"Designed for different uses",text:"Each network is designed differently, and may therefore suit certain apps and experiences."}],em=class extends v.oi{render(){return v.dy`
      <wui-flex
        flexDirection="column"
      ...
      >
        ...
        <wui-button
          variant="fill"
          size="sm"
          @click=${()=>{g.j1.openHref("https://ethereum.org/en/developers/docs/networks/","_blank")}}
        >
          Learn more
          <wui-icon color="inherit" slot="iconRight" name="externalLink"></wui-icon>
        </wui-button>
      </wui-flex>
    `}};em=function(t,s,p,g){var m,v=arguments.length,_=v<3?s:null===g?g=Object.getOwnPropertyDescriptor(s,p):g;if("object"==typeof Reflect&&"function"==typeof Reflect.decorate)_=Reflect.decorate(t,s,p,g);else for(var x=t.length-1;x>=0;x--)(m=t[x])&&(_=(v<3?m(_):v>3?m(s,p,_):m(s,p))||_);return v>3&&_&&Object.defineProperty(s,p,_),_}([(0,m.customElement)("w3m-what-is-a-network-view")],em);let eb=[{images:["login","profile","lock"],title:"One login for all of web3",text:"Log in to any app by connecting your wallet. Say goodbye to countless passwords!"},{images:["defi","nft","eth"],title:"A home for your digital assets",text:"A wallet lets you store, send and receive digital assets like cryptocurrencies and NFTs."},{images:["browser","noun","dao"],title:"Your gateway to a new web",text:"With your wallet, you can explore and interact with DeFi, NFTs, DAOs, and much more."}],ew=class extends v.oi{render(){return v.dy`
      <wui-flex
        flexDirection="column"
        .padding=${["xxl","xl","xl","xl"]}
        alignItems="center"
    ...
    `}onGetWallet(){g.Xs.sendEvent({type:"track",event:"CLICK_GET_WALLET"}),g.RouterController.push("GetWallet")}};ew=function(t,s,p,g){var m,v=arguments.length,_=v<3?s:null===g?g=Object.getOwnPropertyDescriptor(s,p):g;if("object"==typeof Reflect&&"function"==typeof Reflect.decorate)_=Reflect.decorate(t,s,p,g);else for(var x=t.length-1;x>=0;x--)(m=t[x])&&(_=(v<3?m(_):v>3?m(s,p,_):m(s,p))||_);return v>3&&_&&Object.defineProperty(s,p,_),_}([(0,m.customElement)("w3m-what-is-a-wallet-view")],ew);var ey=v.iv`
  wui-grid {
...
`,w3m_all_wallets_list_decorate=function(t,s,p,g){var m,v=arguments.length,_=v<3?s:null===g?g=Object.getOwnPropertyDescriptor(s,p):g;if("object"==typeof Reflect&&"function"==typeof Reflect.decorate)_=Reflect.decorate(t,s,p,g);else for(var x=t.length-1;x>=0;x--)(m=t[x])&&(_=(v<3?m(_):v>3?m(s,p,_):m(s,p))||_);return v>3&&_&&Object.defineProperty(s,p,_),_};let ev="local-paginator",e_=class extends v.oi{constructor(){super(),this.unsubscribe=[],this.paginationObserver=void 0,this.initial=!g.ApiController.state.wallets.length,this.wallets=g.ApiController.state.wallets,this.recommended=g.ApiController.state.recommended,this.featured=g.ApiController.state.featured,this.unsubscribe.push(...[g.ApiController.subscribeKey("wallets",t=>this.wallets=t),g.ApiController.subscribeKey("recommended",t=>this.recommended=t),g.ApiController.subscribeKey("featured",t=>this.featured=t)])}firstUpdated(){this.initialFetch(),this.createPaginationObserver()}disconnectedCallback(){this.unsubscribe.forEach(t=>t()),this.paginationObserver?.disconnect()}render(){return v.dy`
      <wui-grid
    ...
    `}async initialFetch(){let t=this.shadowRoot?.querySelector("wui-grid");this.initial&&t&&(await g.ApiController.fetchWallets({page:1}),await t.animate([{opacity:1},{opacity:0}],{duration:200,fill:"forwards",easing:"ease"}).finished,this.initial=!1,t.animate([{opacity:0},{opacity:1}],{duration:200,fill:"forwards",easing:"ease"}))}shimmerTemplate(t,s){return[...Array(t)].map(()=>v.dy`
        <wui-card-select-loader type="wallet" id=${(0,x.o)(s)}></wui-card-select-loader>
      `)}walletsTemplate(){let t=[...this.featured,...this.recommended,...this.wallets];return t.map(t=>v.dy`
        <wui-card-select
          imageSrc=${(0,x.o)(g.fz.getWalletImage(t))}
          type="wallet"
          name=${t.name}
          @click=${()=>this.onConnectWallet(t)}
        ></wui-card-select>
      `)}paginationLoaderTemplate(){let{wallets:t,recommended:s,featured:p,count:m}=g.ApiController.state,v=window.innerWidth<352?3:4,_=t.length+s.length,x=Math.ceil(_/v)*v-_+v;return(x-=t.length?p.length%v:0,0===m||[...p,...t,...s].length<m)?this.shimmerTemplate(x,ev):null}createPaginationObserver(){let t=this.shadowRoot?.querySelector(`#${ev}`);t&&(this.paginationObserver=new IntersectionObserver(([t])=>{if(t?.isIntersecting&&!this.initial){let{page:t,count:s,wallets:p}=g.ApiController.state;p.length<s&&g.ApiController.fetchWallets({page:t+1})}}),this.paginationObserver.observe(t))}onConnectWallet(t){let{connectors:s}=g.ConnectorController.state,p=s.find(({explorerId:s})=>s===t.id);p?g.RouterController.push("ConnectingExternal",{connector:p}):g.RouterController.push("ConnectingWalletConnect",{wallet:t})}};e_.styles=ey,w3m_all_wallets_list_decorate([(0,_.SB)()],e_.prototype,"initial",void 0),w3m_all_wallets_list_decorate([(0,_.SB)()],e_.prototype,"wallets",void 0),w3m_all_wallets_list_decorate([(0,_.SB)()],e_.prototype,"recommended",void 0),w3m_all_wallets_list_decorate([(0,_.SB)()],e_.prototype,"featured",void 0),e_=w3m_all_wallets_list_decorate([(0,m.customElement)("w3m-all-wallets-list")],e_);var eC=v.iv`
  wui-grid,
  wui-loading-spinner,
  wui-flex {
    height: 360px;
...
`,w3m_all_wallets_search_decorate=function(t,s,p,g){var m,v=arguments.length,_=v<3?s:null===g?g=Object.getOwnPropertyDescriptor(s,p):g;if("object"==typeof Reflect&&"function"==typeof Reflect.decorate)_=Reflect.decorate(t,s,p,g);else for(var x=t.length-1;x>=0;x--)(m=t[x])&&(_=(v<3?m(_):v>3?m(s,p,_):m(s,p))||_);return v>3&&_&&Object.defineProperty(s,p,_),_};let ex=class extends v.oi{constructor(){super(...arguments),this.prevQuery="",this.loading=!0,this.query=""}render(){return this.onSearch(),this.loading?v.dy`<wui-loading-spinner color="accent-100"></wui-loading-spinner>`:this.walletsTemplate()}async onSearch(){this.query!==this.prevQuery&&(this.prevQuery=this.query,this.loading=!0,await g.ApiController.searchWallet({search:this.query}),this.loading=!1)}walletsTemplate(){let{search:t}=g.ApiController.state;return t.length?v.dy`
      <wui-grid
        .padding=${["0","s","s","s"]}
    ...
    `:v.dy`
      ...
      `}onConnectWallet(t){let{connectors:s}=g.ConnectorController.state,p=s.find(({explorerId:s})=>s===t.id);p?g.RouterController.push("ConnectingExternal",{connector:p}):g.RouterController.push("ConnectingWalletConnect",{wallet:t})}};ex.styles=eC,w3m_all_wallets_search_decorate([(0,_.SB)()],ex.prototype,"loading",void 0),w3m_all_wallets_search_decorate([(0,_.Cb)()],ex.prototype,"query",void 0),ex=w3m_all_wallets_search_decorate([(0,m.customElement)("w3m-all-wallets-search")],ex);var w3m_connecting_header_decorate=function(t,s,p,g){var m,v=arguments.length,_=v<3?s:null===g?g=Object.getOwnPropertyDescriptor(s,p):g;if("object"==typeof Reflect&&"function"==typeof Reflect.decorate)_=Reflect.decorate(t,s,p,g);else for(var x=t.length-1;x>=0;x--)(m=t[x])&&(_=(v<3?m(_):v>3?m(s,p,_):m(s,p))||_);return v>3&&_&&Object.defineProperty(s,p,_),_};let eE=class extends v.oi{constructor(){super(),this.platformTabs=[],this.unsubscribe=[],this.platforms=[],this.onSelectPlatfrom=void 0,this.buffering=!1,this.unsubscribe.push(g.ConnectionController.subscribeKey("buffering",t=>this.buffering=t))}disconnectCallback(){this.unsubscribe.forEach(t=>t())}render(){let t=this.generateTabs();return v.dy`
    ...
    `}generateTabs(){let t=this.platforms.map(t=>"browser"===t?{label:"Browser",icon:"extension",platform:"browser"}:"mobile"===t?{label:"Mobile",icon:"mobile",platform:"mobile"}:"qrcode"===t?{label:"Mobile",icon:"mobile",platform:"qrcode"}:"web"===t?{label:"Webapp",icon:"browser",platform:"web"}:"desktop"===t?{label:"Desktop",icon:"desktop",platform:"desktop"}:{label:"Browser",icon:"extension",platform:"unsupported"});return this.platformTabs=t.map(({platform:t})=>t),t}onTabChange(t){let s=this.platformTabs[t];s&&this.onSelectPlatfrom?.(s)}};w3m_connecting_header_decorate([(0,_.Cb)({type:Array})],eE.prototype,"platforms",void 0),w3m_connecting_header_decorate([(0,_.Cb)()],eE.prototype,"onSelectPlatfrom",void 0),w3m_connecting_header_decorate([(0,_.SB)()],eE.prototype,"buffering",void 0),eE=w3m_connecting_header_decorate([(0,m.customElement)("w3m-connecting-header")],eE);let ek=class extends W3mConnectingWidget{constructor(){if(super(),!this.wallet)throw Error("w3m-connecting-wc-browser: No wallet provided");this.onConnect=this.onConnectProxy.bind(this),this.onAutoConnect=this.onConnectProxy.bind(this),g.Xs.sendEvent({type:"track",event:"SELECT_WALLET",properties:{name:this.wallet.name,platform:"browser"}})}async onConnectProxy(){try{this.error=!1;let{connectors:t}=g.ConnectorController.state,s=t.find(t=>"ANNOUNCED"===t.type&&t.info?.rdns===this.wallet?.rdns),p=t.find(t=>"INJECTED"===t.type);s?await g.ConnectionController.connectExternal(s):p&&await g.ConnectionController.connectExternal(p),g.IN.close(),g.Xs.sendEvent({type:"track",event:"CONNECT_SUCCESS",properties:{method:"browser"}})}catch(t){g.Xs.sendEvent({type:"track",event:"CONNECT_ERROR",properties:{message:t?.message??"Unknown"}}),this.error=!0}}};ek=function(t,s,p,g){var m,v=arguments.length,_=v<3?s:null===g?g=Object.getOwnPropertyDescriptor(s,p):g;if("object"==typeof Reflect&&"function"==typeof Reflect.decorate)_=Reflect.decorate(t,s,p,g);else for(var x=t.length-1;x>=0;x--)(m=t[x])&&(_=(v<3?m(_):v>3?m(s,p,_):m(s,p))||_);return v>3&&_&&Object.defineProperty(s,p,_),_}([(0,m.customElement)("w3m-connecting-wc-browser")],ek);let eS=class extends W3mConnectingWidget{constructor(){if(super(),!this.wallet)throw Error("w3m-connecting-wc-desktop: No wallet provided");this.onConnect=this.onConnectProxy.bind(this),this.onRender=this.onRenderProxy.bind(this),g.Xs.sendEvent({type:"track",event:"SELECT_WALLET",properties:{name:this.wallet.name,platform:"desktop"}})}onRenderProxy(){!this.ready&&this.uri&&(this.ready=!0,this.timeout=setTimeout(()=>{this.onConnect?.()},200))}onConnectProxy(){if(this.wallet?.desktop_link&&this.uri)try{this.error=!1;let{desktop_link:t,name:s}=this.wallet,{redirect:p,href:m}=g.j1.formatNativeUrl(t,this.uri);g.ConnectionController.setWcLinking({name:s,href:m}),g.ConnectionController.setRecentWallet(this.wallet),g.j1.openHref(p,"_self")}catch{this.error=!0}}};eS=function(t,s,p,g){var m,v=arguments.length,_=v<3?s:null===g?g=Object.getOwnPropertyDescriptor(s,p):g;if("object"==typeof Reflect&&"function"==typeof Reflect.decorate)_=Reflect.decorate(t,s,p,g);else for(var x=t.length-1;x>=0;x--)(m=t[x])&&(_=(v<3?m(_):v>3?m(s,p,_):m(s,p))||_);return v>3&&_&&Object.defineProperty(s,p,_),_}([(0,m.customElement)("w3m-connecting-wc-desktop")],eS);let eP=class extends W3mConnectingWidget{constructor(){if(super(),!this.wallet)throw Error("w3m-connecting-wc-mobile: No wallet provided");this.onConnect=this.onConnectProxy.bind(this),this.onRender=this.onRenderProxy.bind(this),document.addEventListener("visibilitychange",this.onBuffering.bind(this)),g.Xs.sendEvent({type:"track",event:"SELECT_WALLET",properties:{name:this.wallet.name,platform:"mobile"}})}disconnectedCallback(){super.disconnectedCallback(),document.removeEventListener("visibilitychange",this.onBuffering.bind(this))}onRenderProxy(){!this.ready&&this.uri&&(this.ready=!0,this.onConnect?.())}onConnectProxy(){if(this.wallet?.mobile_link&&this.uri)try{this.error=!1;let{mobile_link:t,name:s}=this.wallet,{redirect:p,href:m}=g.j1.formatNativeUrl(t,this.uri);g.ConnectionController.setWcLinking({name:s,href:m}),g.ConnectionController.setRecentWallet(this.wallet),g.j1.openHref(p,"_self")}catch{this.error=!0}}onBuffering(){let t=g.j1.isIos();document?.visibilityState==="visible"&&!this.error&&t&&(g.ConnectionController.setBuffering(!0),setTimeout(()=>{g.ConnectionController.setBuffering(!1)},5e3))}};eP=function(t,s,p,g){var m,v=arguments.length,_=v<3?s:null===g?g=Object.getOwnPropertyDescriptor(s,p):g;if("object"==typeof Reflect&&"function"==typeof Reflect.decorate)_=Reflect.decorate(t,s,p,g);else for(var x=t.length-1;x>=0;x--)(m=t[x])&&(_=(v<3?m(_):v>3?m(s,p,_):m(s,p))||_);return v>3&&_&&Object.defineProperty(s,p,_),_}([(0,m.customElement)("w3m-connecting-wc-mobile")],eP);var eA=v.iv`
  @keyframes fadein {
    from {
      opacity: 0;
    }
...
`;let eO=class extends W3mConnectingWidget{constructor(){super(),this.forceUpdate=()=>{this.requestUpdate()},window.addEventListener("resize",this.forceUpdate),g.Xs.sendEvent({type:"track",event:"SELECT_WALLET",properties:{name:this.wallet?.name??"WalletConnect",platform:"qrcode"}})}disconnectedCallback(){super.disconnectedCallback(),window.removeEventListener("resize",this.forceUpdate)}render(){return this.onRenderProxy(),v.dy`
      ...
      <w3m-mobile-download-links .wallet=${this.wallet}></w3m-mobile-download-links>
    `}onRenderProxy(){!this.ready&&this.uri&&(this.timeout=setTimeout(()=>{this.ready=!0},200))}qrCodeTemplate(){if(!this.uri||!this.ready)return null;let t=this.getBoundingClientRect().width-40,s=this.wallet?this.wallet.name:void 0;return g.ConnectionController.setWcLinking(void 0),g.ConnectionController.setRecentWallet(this.wallet),v.dy`<wui-qr-code
      size=${t}
      theme=${g.ThemeController.state.themeMode}
      uri=${this.uri}
      imageSrc=${(0,x.o)(g.fz.getWalletImage(this.wallet))}
      alt=${(0,x.o)(s)}
    ></wui-qr-code>`}};eO.styles=eA,eO=function(t,s,p,g){var m,v=arguments.length,_=v<3?s:null===g?g=Object.getOwnPropertyDescriptor(s,p):g;if("object"==typeof Reflect&&"function"==typeof Reflect.decorate)_=Reflect.decorate(t,s,p,g);else for(var x=t.length-1;x>=0;x--)(m=t[x])&&(_=(v<3?m(_):v>3?m(s,p,_):m(s,p))||_);return v>3&&_&&Object.defineProperty(s,p,_),_}([(0,m.customElement)("w3m-connecting-wc-qrcode")],eO);let e$=class extends v.oi{constructor(){if(super(),this.wallet=g.RouterController.state.data?.wallet,!this.wallet)throw Error("w3m-connecting-wc-unsupported: No wallet provided");g.Xs.sendEvent({type:"track",event:"SELECT_WALLET",properties:{name:this.wallet.name,platform:"browser"}})}render(){return v.dy`
      <wui-flex
        flexDirection="column"
        alignItems="center"
        .padding=${["3xl","xl","xl","xl"]}
      ...
      <w3m-mobile-download-links .wallet=${this.wallet}></w3m-mobile-download-links>
    `}};e$=function(t,s,p,g){var m,v=arguments.length,_=v<3?s:null===g?g=Object.getOwnPropertyDescriptor(s,p):g;if("object"==typeof Reflect&&"function"==typeof Reflect.decorate)_=Reflect.decorate(t,s,p,g);else for(var x=t.length-1;x>=0;x--)(m=t[x])&&(_=(v<3?m(_):v>3?m(s,p,_):m(s,p))||_);return v>3&&_&&Object.defineProperty(s,p,_),_}([(0,m.customElement)("w3m-connecting-wc-unsupported")],e$);let eD=class extends W3mConnectingWidget{constructor(){if(super(),!this.wallet)throw Error("w3m-connecting-wc-web: No wallet provided");this.onConnect=this.onConnectProxy.bind(this),this.secondaryBtnLabel="Open",this.secondaryLabel="Open and continue in a new browser tab",this.secondaryBtnIcon="externalLink",g.Xs.sendEvent({type:"track",event:"SELECT_WALLET",properties:{name:this.wallet.name,platform:"web"}})}onConnectProxy(){if(this.wallet?.webapp_link&&this.uri)try{this.error=!1;let{webapp_link:t,name:s}=this.wallet,{redirect:p,href:m}=g.j1.formatUniversalUrl(t,this.uri);g.ConnectionController.setWcLinking({name:s,href:m}),g.ConnectionController.setRecentWallet(this.wallet),g.j1.openHref(p,"_blank")}catch{this.error=!0}}};eD=function(t,s,p,g){var m,v=arguments.length,_=v<3?s:null===g?g=Object.getOwnPropertyDescriptor(s,p):g;if("object"==typeof Reflect&&"function"==typeof Reflect.decorate)_=Reflect.decorate(t,s,p,g);else for(var x=t.length-1;x>=0;x--)(m=t[x])&&(_=(v<3?m(_):v>3?m(s,p,_):m(s,p))||_);return v>3&&_&&Object.defineProperty(s,p,_),_}([(0,m.customElement)("w3m-connecting-wc-web")],eD);var eI=v.iv`
  wui-icon-link[data-hidden='true'] {
    opacity: 0 !important;
    pointer-events: none;
  }
`,w3m_header_decorate=function(t,s,p,g){var m,v=arguments.length,_=v<3?s:null===g?g=Object.getOwnPropertyDescriptor(s,p):g;if("object"==typeof Reflect&&"function"==typeof Reflect.decorate)_=Reflect.decorate(t,s,p,g);else for(var x=t.length-1;x>=0;x--)(m=t[x])&&(_=(v<3?m(_):v>3?m(s,p,_):m(s,p))||_);return v>3&&_&&Object.defineProperty(s,p,_),_};function headings(){let t=g.RouterController.state.data?.connector?.name,s=g.RouterController.state.data?.wallet?.name,p=g.RouterController.state.data?.network?.name,m=s??t;return{Connect:"Connect Wallet",Account:void 0,ConnectingExternal:m??"Connect Wallet",ConnectingWalletConnect:m??"WalletConnect",Networks:"Choose Network",SwitchNetwork:p??"Switch Network",AllWallets:"All Wallets",WhatIsANetwork:"What is a network?",WhatIsAWallet:"What is a wallet?",GetWallet:"Get a Wallet",Downloads:m?`Get ${m}`:"Downloads"}}let eT=class extends v.oi{constructor(){super(),this.unsubscribe=[],this.heading=headings()[g.RouterController.state.view],this.buffering=!1,this.showBack=!1,this.unsubscribe.push(g.RouterController.subscribeKey("view",t=>{this.onViewChange(t),this.onHistoryChange()}),g.ConnectionController.subscribeKey("buffering",t=>this.buffering=t))}disconnectCallback(){this.unsubscribe.forEach(t=>t())}render(){return v.dy`
    ...
    `}onWalletHelp(){g.Xs.sendEvent({type:"track",event:"CLICK_WALLET_HELP"}),g.RouterController.push("WhatIsAWallet")}titleTemplate(){return v.dy`<wui-text variant="paragraph-700" color="fg-100">${this.heading}</wui-text>`}dynamicButtonTemplate(){let{view:t}=g.RouterController.state;return this.showBack?v.dy`<wui-icon-link
        id="dynamic"
        icon="chevronLeft"
        ?disabled=${this.buffering}
        @click=${g.RouterController.goBack}
      ></wui-icon-link>`:v.dy`<wui-icon-link
      data-hidden=${"Connect"!==t}
      id="dynamic"
      icon="helpCircle"
      @click=${this.onWalletHelp.bind(this)}
    ></wui-icon-link>`}separatorTemplate(){return this.heading?v.dy`<wui-separator></wui-separator>`:null}getPadding(){return this.heading?["l","2l","l","2l"]:["l","2l","0","2l"]}async onViewChange(t){let s=this.shadowRoot?.querySelector("wui-text");if(s){let p=headings()[t];await s.animate([{opacity:1},{opacity:0}],{duration:200,fill:"forwards",easing:"ease"}).finished,this.heading=p,s.animate([{opacity:0},{opacity:1}],{duration:200,fill:"forwards",easing:"ease"})}}async onHistoryChange(){let{history:t}=g.RouterController.state,s=this.shadowRoot?.querySelector("#dynamic");t.length>1&&!this.showBack&&s?(await s.animate([{opacity:1},{opacity:0}],{duration:200,fill:"forwards",easing:"ease"}).finished,this.showBack=!0,s.animate([{opacity:0},{opacity:1}],{duration:200,fill:"forwards",easing:"ease"})):t.length<=1&&this.showBack&&s&&(await s.animate([{opacity:1},{opacity:0}],{duration:200,fill:"forwards",easing:"ease"}).finished,this.showBack=!1,s.animate([{opacity:0},{opacity:1}],{duration:200,fill:"forwards",easing:"ease"}))}};eT.styles=[eI],w3m_header_decorate([(0,_.SB)()],eT.prototype,"heading",void 0),w3m_header_decorate([(0,_.SB)()],eT.prototype,"buffering",void 0),w3m_header_decorate([(0,_.SB)()],eT.prototype,"showBack",void 0),eT=w3m_header_decorate([(0,m.customElement)("w3m-header")],eT);var w3m_help_widget_decorate=function(t,s,p,g){var m,v=arguments.length,_=v<3?s:null===g?g=Object.getOwnPropertyDescriptor(s,p):g;if("object"==typeof Reflect&&"function"==typeof Reflect.decorate)_=Reflect.decorate(t,s,p,g);else for(var x=t.length-1;x>=0;x--)(m=t[x])&&(_=(v<3?m(_):v>3?m(s,p,_):m(s,p))||_);return v>3&&_&&Object.defineProperty(s,p,_),_};let eR=class extends v.oi{constructor(){super(...arguments),this.data=[]}render(){return v.dy`
      <wui-flex flexDirection="column" alignItems="center" gap="l">
        ${this.data.map(t=>v.dy`
            <wui-flex flexDirection="column" alignItems="center" gap="xl">
              <wui-flex flexDirection="row" justifyContent="center" gap="1xs">
                ${t.images.map(t=>v.dy`<wui-visual name=${t}></wui-visual>`)}
              </wui-flex>
            </wui-flex>
    ...
    `}};w3m_help_widget_decorate([(0,_.Cb)({type:Array})],eR.prototype,"data",void 0),eR=w3m_help_widget_decorate([(0,m.customElement)("w3m-help-widget")],eR);var eB=v.iv`
  wui-flex {
...
`;let eN=class extends v.oi{render(){let{termsConditionsUrl:t,privacyPolicyUrl:s}=g.OptionsController.state;return t||s?v.dy`
    ...
    `:null}andTemplate(){let{termsConditionsUrl:t,privacyPolicyUrl:s}=g.OptionsController.state;return t&&s?"and":""}termsTemplate(){let{termsConditionsUrl:t}=g.OptionsController.state;return t?v.dy`<a href=${t}>Terms of Service</a>`:null}privacyTemplate(){let{privacyPolicyUrl:t}=g.OptionsController.state;return t?v.dy`<a href=${t}>Privacy Policy</a>`:null}};eN.styles=[eB],eN=function(t,s,p,g){var m,v=arguments.length,_=v<3?s:null===g?g=Object.getOwnPropertyDescriptor(s,p):g;if("object"==typeof Reflect&&"function"==typeof Reflect.decorate)_=Reflect.decorate(t,s,p,g);else for(var x=t.length-1;x>=0;x--)(m=t[x])&&(_=(v<3?m(_):v>3?m(s,p,_):m(s,p))||_);return v>3&&_&&Object.defineProperty(s,p,_),_}([(0,m.customElement)("w3m-legal-footer")],eN);var ej=v.iv`
  :host {
    display: block;
    padding: 0 var(--wui-spacing-xl) var(--wui-spacing-xl);
  }
`,w3m_mobile_download_links_decorate=function(t,s,p,g){var m,v=arguments.length,_=v<3?s:null===g?g=Object.getOwnPropertyDescriptor(s,p):g;if("object"==typeof Reflect&&"function"==typeof Reflect.decorate)_=Reflect.decorate(t,s,p,g);else for(var x=t.length-1;x>=0;x--)(m=t[x])&&(_=(v<3?m(_):v>3?m(s,p,_):m(s,p))||_);return v>3&&_&&Object.defineProperty(s,p,_),_};let eM=class extends v.oi{constructor(){super(...arguments),this.wallet=void 0}render(){if(!this.wallet)return this.style.display="none",null;let{name:t,app_store:s,play_store:p,chrome_store:_,homepage:x}=this.wallet,T=g.j1.isMobile(),F=g.j1.isIos(),W=g.j1.isAndroid(),Z=[s,p,x,_].filter(Boolean).length>1,Q=m.UiHelperUtil.getTruncateString({string:t,charsStart:12,charsEnd:0,truncate:"end"});return Z&&!T?v.dy`
        <wui-cta-button
          label=${`Don't have ${Q}?`}
          buttonLabel="Get"
      ...
      `:p&&W?v.dy`
        <wui-cta-button
          ...
          @click=${this.onPlayStore.bind(this)}
        ></wui-cta-button>
      `:(this.style.display="none",null)}onAppStore(){this.wallet?.app_store&&g.j1.openHref(this.wallet.app_store,"_blank")}onPlayStore(){this.wallet?.play_store&&g.j1.openHref(this.wallet.play_store,"_blank")}onHomePage(){this.wallet?.homepage&&g.j1.openHref(this.wallet.homepage,"_blank")}};eM.styles=[ej],w3m_mobile_download_links_decorate([(0,_.Cb)({type:Object})],eM.prototype,"wallet",void 0),eM=w3m_mobile_download_links_decorate([(0,m.customElement)("w3m-mobile-download-links")],eM);var eU=v.iv`
  :host {
    display: block;
    position: absolute;
    opacity: 0;
...
`,w3m_snackbar_decorate=function(t,s,p,g){var m,v=arguments.length,_=v<3?s:null===g?g=Object.getOwnPropertyDescriptor(s,p):g;if("object"==typeof Reflect&&"function"==typeof Reflect.decorate)_=Reflect.decorate(t,s,p,g);else for(var x=t.length-1;x>=0;x--)(m=t[x])&&(_=(v<3?m(_):v>3?m(s,p,_):m(s,p))||_);return v>3&&_&&Object.defineProperty(s,p,_),_};let eL={success:{backgroundColor:"success-100",iconColor:"success-100",icon:"checkmark"},error:{backgroundColor:"error-100",iconColor:"error-100",icon:"close"}},eF=class extends v.oi{constructor(){super(),this.unsubscribe=[],this.timeout=void 0,this.open=g.SnackController.state.open,this.unsubscribe.push(g.SnackController.subscribeKey("open",t=>{this.open=t,this.onOpen()}))}disconnectedCallback(){clearTimeout(this.timeout),this.unsubscribe.forEach(t=>t())}render(){let{message:t,variant:s}=g.SnackController.state,p=eL[s];return v.dy`
      <wui-snackbar
        message=${t}
        ...
        icon=${p.icon}
      ></wui-snackbar>
    `}onOpen(){clearTimeout(this.timeout),this.open?(this.animate([{opacity:0,transform:"translateX(-50%) scale(0.85)"},{opacity:1,transform:"translateX(-50%) scale(1)"}],{duration:150,fill:"forwards",easing:"ease"}),this.timeout=setTimeout(()=>g.SnackController.hide(),2500)):this.animate([{opacity:1,transform:"translateX(-50%) scale(1)"},{opacity:0,transform:"translateX(-50%) scale(0.85)"}],{duration:150,fill:"forwards",easing:"ease"})}};eF.styles=eU,w3m_snackbar_decorate([(0,_.SB)()],eF.prototype,"open",void 0),eF=w3m_snackbar_decorate([(0,m.customElement)("w3m-snackbar")],eF);let ez=!1;let Web3ModalScaffold=class Web3ModalScaffold{constructor(t){this.initPromise=void 0,this.setIsConnected=t=>{g.AccountController.setIsConnected(t)},this.setCaipAddress=t=>{g.AccountController.setCaipAddress(t)},this.setBalance=(t,s)=>{g.AccountController.setBalance(t,s)},this.setProfileName=t=>{g.AccountController.setProfileName(t)},this.setProfileImage=t=>{g.AccountController.setProfileImage(t)},this.resetAccount=()=>{g.AccountController.resetAccount()},this.setCaipNetwork=t=>{g.NetworkController.setCaipNetwork(t)},this.getCaipNetwork=()=>g.NetworkController.state.caipNetwork,this.setRequestedCaipNetworks=t=>{g.NetworkController.setRequestedCaipNetworks(t)},this.getApprovedCaipNetworksData=()=>g.NetworkController.getApprovedCaipNetworksData(),this.resetNetwork=()=>{g.NetworkController.resetNetwork()},this.setConnectors=t=>{g.ConnectorController.setConnectors(t)},this.addConnector=t=>{g.ConnectorController.addConnector(t)},this.getConnectors=()=>g.ConnectorController.getConnectors(),this.resetWcConnection=()=>{g.ConnectionController.resetWcConnection()},this.fetchIdentity=t=>g.Lr.fetchIdentity(t),this.setAddressExplorerUrl=t=>{g.AccountController.setAddressExplorerUrl(t)},this.initControllers(t),this.initOrContinue()}async open(t){await this.initOrContinue(),g.IN.open(t)}async close(){await this.initOrContinue(),g.IN.close()}getThemeMode(){return g.ThemeController.state.themeMode}getThemeVariables(){return g.ThemeController.state.themeVariables}setThemeMode(t){g.ThemeController.setThemeMode(t),(0,m.setColorTheme)(g.ThemeController.state.themeMode)}setThemeVariables(t){g.ThemeController.setThemeVariables(t),(0,m.setThemeVariables)(g.ThemeController.state.themeVariables)}subscribeTheme(t){return g.ThemeController.subscribe(t)}getState(){return{...g.Ie.state}}subscribeState(t){return g.Ie.subscribe(t)}getEvent(){return{...g.Xs.state}}subscribeEvents(t){return g.Xs.subscribe(t)}initControllers(t){g.NetworkController.setClient(t.networkControllerClient),g.NetworkController.setDefaultCaipNetwork(t.defaultChain),g.OptionsController.setProjectId(t.projectId),g.OptionsController.setIncludeWalletIds(t.includeWalletIds),g.OptionsController.setExcludeWalletIds(t.excludeWalletIds),g.OptionsController.setFeaturedWalletIds(t.featuredWalletIds),g.OptionsController.setTokens(t.tokens),g.OptionsController.setTermsConditionsUrl(t.termsConditionsUrl),g.OptionsController.setPrivacyPolicyUrl(t.privacyPolicyUrl),g.OptionsController.setCustomWallets(t.customWallets),g.OptionsController.setEnableAnalytics(t.enableAnalytics),g.OptionsController.setSdkVersion(t._sdkVersion),g.ConnectionController.setClient(t.connectionControllerClient),t.themeMode&&g.ThemeController.setThemeMode(t.themeMode),t.themeVariables&&g.ThemeController.setThemeVariables(t.themeVariables)}async initOrContinue(){return!this.initPromise&&!ez&&g.j1.isClient()&&(ez=!0,this.initPromise=new Promise(async t=>{await Promise.all([Promise.resolve().then(p.bind(p,19704)),Promise.resolve().then(p.bind(p,90078))]);let s=document.createElement("w3m-modal");document.body.insertAdjacentElement("beforeend",s),t()})),this.initPromise}}},90078:function(t,s,p){"use strict";p.r(s),p.d(s,{W3mModal:function(){return F}});var g=p(36635),m=p(19704),v=p(77996),_=p(37380),x=v.iv`
  :host {
...
<svg width="36" height="36">
  ...
  <path
    ...
    clip-rule="evenodd"
  />
</svg>`,ej=_.YP`<svg fill="none" viewBox="0 0 16 16">
  <path
    fill="currentColor"
    fill-rule="evenodd"
...
>
  ...
  <path
    ...
    stroke-opacity=".05"
  />
</svg>`,eU=_.YP`<svg fill="none" viewBox="0 0 20 20">
  <path
    fill="currentColor"
...
`,wui_avatar_decorate=function(t,s,p,g){var m,v=arguments.length,_=v<3?s:null===g?g=Object.getOwnPropertyDescriptor(s,p):g;if("object"==typeof Reflect&&"function"==typeof Reflect.decorate)_=Reflect.decorate(t,s,p,g);else for(var x=t.length-1;x>=0;x--)(m=t[x])&&(_=(v<3?m(_):v>3?m(s,p,_):m(s,p))||_);return v>3&&_&&Object.defineProperty(s,p,_),_};let tS=class extends _.oi{constructor(){super(...arguments),this.imageSrc=void 0,this.alt=void 0,this.address=void 0}render(){return _.dy`${this.visualTemplate()}`}visualTemplate(){if(this.imageSrc)return this.dataset.variant="image",_.dy`<wui-image src=${this.imageSrc} alt=${this.alt??"avatar"}></wui-image>`;if(this.address){this.dataset.variant="generated";let t=tC.generateAvatarColors(this.address);return this.style.cssText=t,null}return this.dataset.variant="default",null}};tS.styles=[x,tk],wui_avatar_decorate([(0,Q.Cb)()],tS.prototype,"imageSrc",void 0),wui_avatar_decorate([(0,Q.Cb)()],tS.prototype,"alt",void 0),wui_avatar_decorate([(0,Q.Cb)()],tS.prototype,"address",void 0),tS=wui_avatar_decorate([customElement("wui-avatar")],tS);var tP=_.iv`
  :host {
    display: inline-flex;
    justify-content: center;
    align-items: center;
...
`,wui_account_button_decorate=function(t,s,p,g){var m,v=arguments.length,_=v<3?s:null===g?g=Object.getOwnPropertyDescriptor(s,p):g;if("object"==typeof Reflect&&"function"==typeof Reflect.decorate)_=Reflect.decorate(t,s,p,g);else for(var x=t.length-1;x>=0;x--)(m=t[x])&&(_=(v<3?m(_):v>3?m(s,p,_):m(s,p))||_);return v>3&&_&&Object.defineProperty(s,p,_),_};let t$=class extends _.oi{constructor(){super(...arguments),this.networkSrc=void 0,this.avatarSrc=void 0,this.balance=void 0,this.disabled=!1,this.isProfileName=!1,this.address=""}render(){return _.dy`
    ...
    `}balanceTemplate(){if(this.balance){let t=this.networkSrc?_.dy`<wui-image src=${this.networkSrc}></wui-image>`:_.dy`
      ...
      `}return null}};t$.styles=[x,T,tO],wui_account_button_decorate([(0,Q.Cb)()],t$.prototype,"networkSrc",void 0),wui_account_button_decorate([(0,Q.Cb)()],t$.prototype,"avatarSrc",void 0),wui_account_button_decorate([(0,Q.Cb)()],t$.prototype,"balance",void 0),wui_account_button_decorate([(0,Q.Cb)({type:Boolean})],t$.prototype,"disabled",void 0),wui_account_button_decorate([(0,Q.Cb)({type:Boolean})],t$.prototype,"isProfileName",void 0),wui_account_button_decorate([(0,Q.Cb)()],t$.prototype,"address",void 0),t$=wui_account_button_decorate([customElement("wui-account-button")],t$);var tD=_.iv`
  :host {
    position: relative;
    border-radius: inherit;
    overflow: hidden;
...
`,wui_wallet_image_decorate=function(t,s,p,g){var m,v=arguments.length,_=v<3?s:null===g?g=Object.getOwnPropertyDescriptor(s,p):g;if("object"==typeof Reflect&&"function"==typeof Reflect.decorate)_=Reflect.decorate(t,s,p,g);else for(var x=t.length-1;x>=0;x--)(m=t[x])&&(_=(v<3?m(_):v>3?m(s,p,_):m(s,p))||_);return v>3&&_&&Object.defineProperty(s,p,_),_};let tI=class extends _.oi{constructor(){super(...arguments),this.size="md",this.name=""}render(){let t="xxs";return t="lg"===this.size?"m":"md"===this.size?"xs":"xxs",this.style.cssText=`
...
`,wui_all_wallets_image_decorate=function(t,s,p,g){var m,v=arguments.length,_=v<3?s:null===g?g=Object.getOwnPropertyDescriptor(s,p):g;if("object"==typeof Reflect&&"function"==typeof Reflect.decorate)_=Reflect.decorate(t,s,p,g);else for(var x=t.length-1;x>=0;x--)(m=t[x])&&(_=(v<3?m(_):v>3?m(s,p,_):m(s,p))||_);return v>3&&_&&Object.defineProperty(s,p,_),_};let tR=class extends _.oi{constructor(){super(...arguments),this.walletImages=[]}render(){let t=this.walletImages.length<4;return _.dy`${this.walletImages.slice(0,4).map(({src:t,walletName:s})=>_.dy`
          ...
          ></wui-wallet-image>
        `)}
    ${t?[...Array(4-this.walletImages.length)].map(()=>_.dy` <wui-wallet-image size="inherit" name=""></wui-wallet-image>`):null}`}};tR.styles=[x,tT],wui_all_wallets_image_decorate([(0,Q.Cb)({type:Array})],tR.prototype,"walletImages",void 0),tR=wui_all_wallets_image_decorate([customElement("wui-all-wallets-image")],tR);var tB=_.iv`
  :host {
    width: var(--local-width);
    position: relative;
  }
...
`,wui_button_decorate=function(t,s,p,g){var m,v=arguments.length,_=v<3?s:null===g?g=Object.getOwnPropertyDescriptor(s,p):g;if("object"==typeof Reflect&&"function"==typeof Reflect.decorate)_=Reflect.decorate(t,s,p,g);else for(var x=t.length-1;x>=0;x--)(m=t[x])&&(_=(v<3?m(_):v>3?m(s,p,_):m(s,p))||_);return v>3&&_&&Object.defineProperty(s,p,_),_};let tN=class extends _.oi{constructor(){super(...arguments),this.size="md",this.disabled=!1,this.loading=!1,this.variant="fill"}render(){this.style.cssText=`
    ...
    `}loadingTemplate(){return this.loading?_.dy`<wui-loading-spinner color="fg-300"></wui-loading-spinner>`:_.dy``}};tN.styles=[x,T,tB],wui_button_decorate([(0,Q.Cb)()],tN.prototype,"size",void 0),wui_button_decorate([(0,Q.Cb)({type:Boolean})],tN.prototype,"disabled",void 0),wui_button_decorate([(0,Q.Cb)({type:Boolean})],tN.prototype,"loading",void 0),wui_button_decorate([(0,Q.Cb)()],tN.prototype,"variant",void 0),tN=wui_button_decorate([customElement("wui-button")],tN);let tj=_.YP`<svg  viewBox="0 0 48 54" fill="none">
  <path
...
`,wui_card_select_loader_decorate=function(t,s,p,g){var m,v=arguments.length,_=v<3?s:null===g?g=Object.getOwnPropertyDescriptor(s,p):g;if("object"==typeof Reflect&&"function"==typeof Reflect.decorate)_=Reflect.decorate(t,s,p,g);else for(var x=t.length-1;x>=0;x--)(m=t[x])&&(_=(v<3?m(_):v>3?m(s,p,_):m(s,p))||_);return v>3&&_&&Object.defineProperty(s,p,_),_};let tU=class extends _.oi{constructor(){super(...arguments),this.type="wallet"}render(){return _.dy`
    ...
    `}shimmerTemplate(){return"network"===this.type?_.dy` <wui-shimmer
          ...
          borderRadius="xs"
        ></wui-shimmer>
        ${tj}`:_.dy`<wui-shimmer width="56px" height="56px" borderRadius="xs"></wui-shimmer>`}};tU.styles=[x,T,tM],wui_card_select_loader_decorate([(0,Q.Cb)()],tU.prototype,"type",void 0),tU=wui_card_select_loader_decorate([customElement("wui-card-select-loader")],tU);let tL=_.YP`<svg width="86" height="96" fill="none">
  <path
...
`,wui_card_select_decorate=function(t,s,p,g){var m,v=arguments.length,_=v<3?s:null===g?g=Object.getOwnPropertyDescriptor(s,p):g;if("object"==typeof Reflect&&"function"==typeof Reflect.decorate)_=Reflect.decorate(t,s,p,g);else for(var x=t.length-1;x>=0;x--)(m=t[x])&&(_=(v<3?m(_):v>3?m(s,p,_):m(s,p))||_);return v>3&&_&&Object.defineProperty(s,p,_),_};let tq=class extends _.oi{constructor(){super(...arguments),this.name="Unknown",this.type="wallet",this.imageSrc=void 0,this.disabled=!1,this.selected=!1}render(){return _.dy`
    ...
    `}};tq.styles=[x,T,tW],wui_card_select_decorate([(0,Q.Cb)()],tq.prototype,"name",void 0),wui_card_select_decorate([(0,Q.Cb)()],tq.prototype,"type",void 0),wui_card_select_decorate([(0,Q.Cb)()],tq.prototype,"imageSrc",void 0),wui_card_select_decorate([(0,Q.Cb)({type:Boolean})],tq.prototype,"disabled",void 0),wui_card_select_decorate([(0,Q.Cb)({type:Boolean})],tq.prototype,"selected",void 0),tq=wui_card_select_decorate([customElement("wui-card-select")],tq);var tH=_.iv`
  a {
    border: 1px solid var(--wui-gray-glass-010);
    border-radius: var(--wui-border-radius-3xl);
  }
...
`,wui_chip_decorate=function(t,s,p,g){var m,v=arguments.length,_=v<3?s:null===g?g=Object.getOwnPropertyDescriptor(s,p):g;if("object"==typeof Reflect&&"function"==typeof Reflect.decorate)_=Reflect.decorate(t,s,p,g);else for(var x=t.length-1;x>=0;x--)(m=t[x])&&(_=(v<3?m(_):v>3?m(s,p,_):m(s,p))||_);return v>3&&_&&Object.defineProperty(s,p,_),_};let tG=class extends _.oi{constructor(){super(...arguments),this.variant="fill",this.imageSrc=void 0,this.disabled=!1,this.icon="externalLink",this.href=""}render(){let t="transparent"===this.variant?"small-600":"paragraph-600";return _.dy`
    ...
    `}imageTemplate(){return this.imageSrc?_.dy`<wui-image src=${this.imageSrc}></wui-image>`:null}};tG.styles=[x,T,tH],wui_chip_decorate([(0,Q.Cb)()],tG.prototype,"variant",void 0),wui_chip_decorate([(0,Q.Cb)()],tG.prototype,"imageSrc",void 0),wui_chip_decorate([(0,Q.Cb)({type:Boolean})],tG.prototype,"disabled",void 0),wui_chip_decorate([(0,Q.Cb)()],tG.prototype,"icon",void 0),wui_chip_decorate([(0,Q.Cb)()],tG.prototype,"href",void 0),tG=wui_chip_decorate([customElement("wui-chip")],tG);var tZ=_.iv`
  :host {
    position: relative;
    display: block;
  }
...
`,wui_logo_select_decorate=function(t,s,p,g){var m,v=arguments.length,_=v<3?s:null===g?g=Object.getOwnPropertyDescriptor(s,p):g;if("object"==typeof Reflect&&"function"==typeof Reflect.decorate)_=Reflect.decorate(t,s,p,g);else for(var x=t.length-1;x>=0;x--)(m=t[x])&&(_=(v<3?m(_):v>3?m(s,p,_):m(s,p))||_);return v>3&&_&&Object.defineProperty(s,p,_),_};let rv=class extends _.oi{constructor(){super(...arguments),this.logo="google",this.disabled=!1}render(){return _.dy`
    ...
    `}};rv.styles=[x,T,ry],wui_logo_select_decorate([(0,Q.Cb)()],rv.prototype,"logo",void 0),wui_logo_select_decorate([(0,Q.Cb)({type:Boolean})],rv.prototype,"disabled",void 0),rv=wui_logo_select_decorate([customElement("wui-logo-select")],rv);var r_=_.iv`
  :host {
    display: block;
  }
...
`,wui_network_button_decorate=function(t,s,p,g){var m,v=arguments.length,_=v<3?s:null===g?g=Object.getOwnPropertyDescriptor(s,p):g;if("object"==typeof Reflect&&"function"==typeof Reflect.decorate)_=Reflect.decorate(t,s,p,g);else for(var x=t.length-1;x>=0;x--)(m=t[x])&&(_=(v<3?m(_):v>3?m(s,p,_):m(s,p))||_);return v>3&&_&&Object.defineProperty(s,p,_),_};let rC=class extends _.oi{constructor(){super(...arguments),this.imageSrc=void 0,this.disabled=!1}render(){return _.dy`
    ...
    `}visualTemplate(){return this.imageSrc?_.dy`<wui-image src=${this.imageSrc}></wui-image>`:_.dy`
      <wui-icon-box
        ...
        icon="networkPlaceholder"
      ></wui-icon-box>
    `}};rC.styles=[x,T,r_],wui_network_button_decorate([(0,Q.Cb)()],rC.prototype,"imageSrc",void 0),wui_network_button_decorate([(0,Q.Cb)({type:Boolean})],rC.prototype,"disabled",void 0),rC=wui_network_button_decorate([customElement("wui-network-button")],rC);var rx=_.iv`
  :host {
    position: relative;
    display: block;
  }
...
`;let r$=class extends _.oi{constructor(){super(...arguments),this.inputComponentRef=ref_e()}render(){return _.dy`
    ...
    `}clearValue(){let t=this.inputComponentRef.value,s=t?.inputElementRef.value;s&&(s.value="",s.focus(),s.dispatchEvent(new Event("input")))}};r$.styles=[x,rO],r$=function(t,s,p,g){var m,v=arguments.length,_=v<3?s:null===g?g=Object.getOwnPropertyDescriptor(s,p):g;if("object"==typeof Reflect&&"function"==typeof Reflect.decorate)_=Reflect.decorate(t,s,p,g);else for(var x=t.length-1;x>=0;x--)(m=t[x])&&(_=(v<3?m(_):v>3?m(s,p,_):m(s,p))||_);return v>3&&_&&Object.defineProperty(s,p,_),_}([customElement("wui-search-bar")],r$);var rD=_.iv`
  :host {
    display: flex;
    column-gap: var(--wui-spacing-xs);
    align-items: center;
...
`,wui_snackbar_decorate=function(t,s,p,g){var m,v=arguments.length,_=v<3?s:null===g?g=Object.getOwnPropertyDescriptor(s,p):g;if("object"==typeof Reflect&&"function"==typeof Reflect.decorate)_=Reflect.decorate(t,s,p,g);else for(var x=t.length-1;x>=0;x--)(m=t[x])&&(_=(v<3?m(_):v>3?m(s,p,_):m(s,p))||_);return v>3&&_&&Object.defineProperty(s,p,_),_};let rI=class extends _.oi{constructor(){super(...arguments),this.backgroundColor="accent-100",this.iconColor="accent-100",this.icon="checkmark",this.message=""}render(){return _.dy`
      <wui-icon-box
        size="sm"
    ...
    `}};rI.styles=[x,rD],wui_snackbar_decorate([(0,Q.Cb)()],rI.prototype,"backgroundColor",void 0),wui_snackbar_decorate([(0,Q.Cb)()],rI.prototype,"iconColor",void 0),wui_snackbar_decorate([(0,Q.Cb)()],rI.prototype,"icon",void 0),wui_snackbar_decorate([(0,Q.Cb)()],rI.prototype,"message",void 0),rI=wui_snackbar_decorate([customElement("wui-snackbar")],rI);var rT=_.iv`
  :host {
    display: inline-flex;
    background-color: var(--wui-gray-glass-002);
    border-radius: var(--wui-border-radius-3xl);
...
`,wui_tabs_decorate=function(t,s,p,g){var m,v=arguments.length,_=v<3?s:null===g?g=Object.getOwnPropertyDescriptor(s,p):g;if("object"==typeof Reflect&&"function"==typeof Reflect.decorate)_=Reflect.decorate(t,s,p,g);else for(var x=t.length-1;x>=0;x--)(m=t[x])&&(_=(v<3?m(_):v>3?m(s,p,_):m(s,p))||_);return v>3&&_&&Object.defineProperty(s,p,_),_};let rR=class extends _.oi{constructor(){super(...arguments),this.tabs=[],this.onTabChange=()=>null,this.buttons=[],this.disabled=!1,this.activeTab=0,this.localTabWidth="100px",this.isDense=!1}render(){return this.isDense=this.tabs.length>3,this.style.cssText=`
    ...
    `,this.dataset.type=this.isDense?"flex":"block",this.tabs.map((t,s)=>{let p=s===this.activeTab;return _.dy`
      ...
      `})}firstUpdated(){this.shadowRoot&&this.isDense&&(this.buttons=[...this.shadowRoot.querySelectorAll("button")],setTimeout(()=>{this.animateTabs(0,!0)},0))}onTabClick(t){this.buttons&&this.animateTabs(t,!1),this.activeTab=t,this.onTabChange(t)}animateTabs(t,s){let p=this.buttons[this.activeTab],g=this.buttons[t],m=p?.querySelector("wui-text"),v=g?.querySelector("wui-text"),_=g?.getBoundingClientRect(),x=v?.getBoundingClientRect();p&&m&&!s&&t!==this.activeTab&&(m.animate([{opacity:0}],{duration:200,easing:"ease",fill:"forwards"}),p.animate([{width:"34px"}],{duration:500,easing:"ease",fill:"forwards"})),g&&_&&x&&v&&(t!==this.activeTab||s)&&(this.localTabWidth=`${Math.round(_.width+x.width)+6}px`,g.animate([{width:`${_.width+x.width}px`}],{duration:s?0:500,fill:"forwards",easing:"ease"}),v.animate([{opacity:1}],{duration:s?0:250,delay:s?0:50,fill:"forwards",easing:"ease"}))}};rR.styles=[x,T,rT],wui_tabs_decorate([(0,Q.Cb)({type:Array})],rR.prototype,"tabs",void 0),wui_tabs_decorate([(0,Q.Cb)()],rR.prototype,"onTabChange",void 0),wui_tabs_decorate([(0,Q.Cb)({type:Array})],rR.prototype,"buttons",void 0),wui_tabs_decorate([(0,Q.Cb)({type:Boolean})],rR.prototype,"disabled",void 0),wui_tabs_decorate([(0,Q.SB)()],rR.prototype,"activeTab",void 0),wui_tabs_decorate([(0,Q.SB)()],rR.prototype,"localTabWidth",void 0),wui_tabs_decorate([(0,Q.SB)()],rR.prototype,"isDense",void 0),rR=wui_tabs_decorate([customElement("wui-tabs")],rR);var rB=_.iv`
  :host {
    display: block;
...
`,wui_tooltip_decorate=function(t,s,p,g){var m,v=arguments.length,_=v<3?s:null===g?g=Object.getOwnPropertyDescriptor(s,p):g;if("object"==typeof Reflect&&"function"==typeof Reflect.decorate)_=Reflect.decorate(t,s,p,g);else for(var x=t.length-1;x>=0;x--)(m=t[x])&&(_=(v<3?m(_):v>3?m(s,p,_):m(s,p))||_);return v>3&&_&&Object.defineProperty(s,p,_),_};let rN=class extends _.oi{constructor(){super(...arguments),this.placement="top",this.message=""}render(){return _.dy`<wui-icon
        ...
        name="cursor"
      ></wui-icon>
      <wui-text color="inherit" variant="small-500">${this.message}</wui-text>`}};rN.styles=[x,T,rB],wui_tooltip_decorate([(0,Q.Cb)()],rN.prototype,"placement",void 0),wui_tooltip_decorate([(0,Q.Cb)()],rN.prototype,"message",void 0),rN=wui_tooltip_decorate([customElement("wui-tooltip")],rN);var rj=_.iv`
  :host {
    display: grid;
    width: inherit;
    height: inherit;
...
`,wui_grid_decorate=function(t,s,p,g){var m,v=arguments.length,_=v<3?s:null===g?g=Object.getOwnPropertyDescriptor(s,p):g;if("object"==typeof Reflect&&"function"==typeof Reflect.decorate)_=Reflect.decorate(t,s,p,g);else for(var x=t.length-1;x>=0;x--)(m=t[x])&&(_=(v<3?m(_):v>3?m(s,p,_):m(s,p))||_);return v>3&&_&&Object.defineProperty(s,p,_),_};let rM=class extends _.oi{render(){return this.style.cssText=`
      ...
      margin-bottom: ${this.margin&&tC.getSpacingStyles(this.margin,2)};
      margin-left: ${this.margin&&tC.getSpacingStyles(this.margin,3)};
    `,_.dy`<slot></slot>`}};rM.styles=[x,rj],wui_grid_decorate([(0,Q.Cb)()],rM.prototype,"gridTemplateRows",void 0),wui_grid_decorate([(0,Q.Cb)()],rM.prototype,"gridTemplateColumns",void 0),wui_grid_decorate([(0,Q.Cb)()],rM.prototype,"justifyItems",void 0),wui_grid_decorate([(0,Q.Cb)()],rM.prototype,"alignItems",void 0),wui_grid_decorate([(0,Q.Cb)()],rM.prototype,"justifyContent",void 0),wui_grid_decorate([(0,Q.Cb)()],rM.prototype,"alignContent",void 0),wui_grid_decorate([(0,Q.Cb)()],rM.prototype,"columnGap",void 0),wui_grid_decorate([(0,Q.Cb)()],rM.prototype,"rowGap",void 0),wui_grid_decorate([(0,Q.Cb)()],rM.prototype,"gap",void 0),wui_grid_decorate([(0,Q.Cb)()],rM.prototype,"padding",void 0),wui_grid_decorate([(0,Q.Cb)()],rM.prototype,"margin",void 0),rM=wui_grid_decorate([customElement("wui-grid")],rM);var rU=_.iv`
  :host {
    position: relative;
    display: flex;
    width: 100%;
...
`,wui_separator_decorate=function(t,s,p,g){var m,v=arguments.length,_=v<3?s:null===g?g=Object.getOwnPropertyDescriptor(s,p):g;if("object"==typeof Reflect&&"function"==typeof Reflect.decorate)_=Reflect.decorate(t,s,p,g);else for(var x=t.length-1;x>=0;x--)(m=t[x])&&(_=(v<3?m(_):v>3?m(s,p,_):m(s,p))||_);return v>3&&_&&Object.defineProperty(s,p,_),_};let rL=class extends _.oi{constructor(){super(...arguments),this.text=""}render(){return _.dy`${this.template()}`}template(){return this.text?_.dy`<wui-text variant="small-500" color="fg-200">${this.text}</wui-text>`:null}};rL.styles=[x,rU],wui_separator_decorate([(0,Q.Cb)()],rL.prototype,"text",void 0),rL=wui_separator_decorate([customElement("wui-separator")],rL)},42024:function(t,s,p){"use strict";let g;p.d(s,{RE:function(){return _.R},OY:function(){return createWeb3Modal},k_:function(){return useWeb3Modal}}),p(67294);var m=p(13507),v=p(29583),_=p(94845);function createWeb3Modal(t){return g||(g=new m.E({...t,_sdkVersion:`react-wagmi-${v.q4}`})),g}function useWeb3Modal(){if(!g)throw Error('Please call "createWeb3Modal" before using "useWeb3Modal" hook');return{open:async function(t){await g?.open(t)},close:async function(){await g?.close()}}}p(74146),p(19568)},13507:function(t,s,p){"use strict";p.d(s,{E:function(){return Web3Modal}});var g=p(65598),m=p(66403),v=p(83756),_=p(29583);let x={1:"692ed6ba-e569-459a-556a-776476829e00",42161:"600a9a04-c1b9-42ca-6785-9b4b6ff85200",43114:"30c46e53-e989-45fb-4549-be3bd4eb3b00",56:"93564157-2e8e-4ce7-81df-b264dbee9b00",250:"06b26297-fe0c-4733-5d6b-ffa5498aac00",10:"ab9c186a-c52f-464b-2906-ca59d760a400",137:"41d04d42-da3b-4453-8506-668cc0727900",100:"02b53f6a-e3d4-479e-1cb4-21178987d100",9001:"f926ff41-260d-4028-635e-91913fc28e00",324:"b310f07f-4ef7-49f3-7073-2a0a39685800",314:"5a73b3dd-af74-424e-cae0-0de859ee9400",4689:"34e68754-e536-40da-c153-6ef2e7188a00",1088:"3897a66d-40b9-4833-162f-a2c90531c900",1284:"161038da-44ae-4ec7-1208-0ea569454b00",1285:"f1d73bb6-5450-4e18-38f7-fb6484264a00",7777777:"845c60df-d429-4991-e687-91ae45791600",42220:"ab781bbc-ccc6-418d-d32d-789b15da1f00",8453:"7289c336-3981-4081-c5f4-efc26ac64a00",1313161554:"3ff73439-a619-4894-9262-4470c773a100"},T={[_.z3]:"0c2840c3-5b04-4c44-9661-fbd4b49e1800",[_.aS]:"461db637-8616-43ce-035a-d89b8a1d5800",[_.FT]:"54a1aa77-d202-4f8d-0fb2-5d2bb6db0300",[_.N$]:"ef1a1fcf-7fe8-4d69-bd6d-fda1345b4400",[_.i1]:"07ba87ed-43aa-4adf-4540-9e6a2b9cae00"},F={[_.z3]:"fd20dc426fb37566d803205b19bbc1d4096b248ac04548e3cfb6b3a38bd033aa",[_.aS]:"225affb176778569276e484e1b92637ad061b01e13a048b35a9d280c3b58970f",[_.FT]:"19177a98252e07ddfc9af2083ba8e07ef627cb6103467ffebb3f8f4205fd7927"},W={[_.i1]:"Browser Wallet",[_.N$]:"WalletConnect",[_.z3]:"Coinbase",[_.FT]:"Ledger",[_.aS]:"Safe"},Z={[_.i1]:"INJECTED",[_.N$]:"WALLET_CONNECT",[_.ky]:"ANNOUNCED"};function caipNetworkIdToNumber(t){return t?Number(t.split(":")[1]):void 0}let Web3Modal=class Web3Modal extends v.D4{constructor(t){let{wagmiConfig:s,chains:p,defaultChain:m,tokens:v,_sdkVersion:T,...F}=t;if(!s)throw Error("web3modal:constructor - wagmiConfig is undefined");if(!F.projectId)throw Error("web3modal:constructor - projectId is undefined");if(!s.connectors.find(t=>t.id===_.N$))throw Error("web3modal:constructor - WalletConnectConnector is required");let W={connectWalletConnect:async t=>{let p=s.connectors.find(t=>t.id===_.N$);if(!p)throw Error("connectionControllerClient:getWalletConnectUri - connector is undefined");p.on("message",s=>{"display_uri"===s.type&&(t(s.data),p.removeAllListeners())});let m=caipNetworkIdToNumber(this.getCaipNetwork()?.id);await (0,g.$j)({connector:p,chainId:m})},connectExternal:async({id:t,provider:p,info:m})=>{let v=s.connectors.find(s=>s.id===t);if(!v)throw Error("connectionControllerClient:connectExternal - connector is undefined");p&&m&&v.id===_.ky&&v.setEip6963Wallet?.({provider:p,info:m});let x=caipNetworkIdToNumber(this.getCaipNetwork()?.id);await (0,g.$j)({connector:v,chainId:x})},checkInstalled:t=>{let s=this.getConnectors().filter(t=>"ANNOUNCED"===t.type),p=this.getConnectors().find(t=>"INJECTED"===t.type);if(!t)return!!window.ethereum;if(s.length){let p=t.some(t=>s.some(s=>s.info?.rdns===t));if(p)return!0}return!!p&&!!window?.ethereum&&t.some(t=>!!window.ethereum?.[String(t)])},disconnect:g.zP};super({networkControllerClient:{switchCaipNetwork:async t=>{let s=caipNetworkIdToNumber(t?.id);s&&await (0,g.If)({chainId:s})},async getApprovedCaipNetworksData(){let t=localStorage.getItem(_.WF);if(t?.includes(_.N$)){let t=s.connectors.find(t=>t.id===_.N$);if(!t)throw Error("networkControllerClient:getApprovedCaipNetworks - connector is undefined");let p=await t.getProvider(),g=p.signer?.session?.namespaces,m=g?.[_.A7]?.methods,v=g?.[_.A7]?.chains;return{supportsAllNetworks:m?.includes(_.kf),approvedCaipNetworkIds:v}}return{approvedCaipNetworkIds:void 0,supportsAllNetworks:!0}}},connectionControllerClient:W,defaultChain:function(t){if(t)return{id:`${_.A7}:${t.id}`,name:t.name,imageId:x[t.id]}}(m),tokens:function(t){if(!t)return;let s={};return Object.entries(t).forEach(([t,p])=>{s[`${_.A7}:${t}`]=p}),s}(v),_sdkVersion:T??`html-wagmi-${_.q4}`,...F}),this.hasSyncedConnectedAccount=!1,this.options=void 0,this.options=t,this.syncRequestedNetworks(p),this.syncConnectors(s),this.listenConnectors(s),(0,g.uH)(()=>this.syncAccount()),(0,g.QC)(()=>this.syncNetwork())}getState(){let t=super.getState();return{...t,selectedNetworkId:caipNetworkIdToNumber(t.selectedNetworkId)}}subscribeState(t){return super.subscribeState(s=>t({...s,selectedNetworkId:caipNetworkIdToNumber(s.selectedNetworkId)}))}syncRequestedNetworks(t){let s=t?.map(t=>({id:`${_.A7}:${t.id}`,name:t.name,imageId:x[t.id],imageUrl:this.options?.chainImages?.[t.id]}));this.setRequestedCaipNetworks(s??[])}async syncAccount(){let{address:t,isConnected:s}=(0,g.D0)(),{chain:p}=(0,g.Hy)();if(this.resetAccount(),s&&t&&p){let g=`${_.A7}:${p.id}:${t}`;this.setIsConnected(s),this.setCaipAddress(g),await Promise.all([this.syncProfile(t),this.syncBalance(t,p),this.getApprovedCaipNetworksData()]),this.hasSyncedConnectedAccount=!0}else!s&&this.hasSyncedConnectedAccount&&(this.resetWcConnection(),this.resetNetwork())}async syncNetwork(){let{address:t,isConnected:s}=(0,g.D0)(),{chain:p}=(0,g.Hy)();if(p){let g=String(p.id),m=`${_.A7}:${g}`;if(this.setCaipNetwork({id:m,name:p.name,imageId:x[p.id],imageUrl:this.options?.chainImages?.[p.id]}),s&&t){let s=`${_.A7}:${p.id}:${t}`;if(this.setCaipAddress(s),p.blockExplorers?.default?.url){let s=`${p.blockExplorers.default.url}/address/${t}`;this.setAddressExplorerUrl(s)}else this.setAddressExplorerUrl(void 0);this.hasSyncedConnectedAccount&&await this.syncBalance(t,p)}}}async syncProfile(t){try{let{name:s,avatar:p}=await this.fetchIdentity({caipChainId:`${_.A7}:${m.R.id}`,address:t});this.setProfileName(s),this.setProfileImage(p)}catch{let s=await (0,g.Lk)({address:t,chainId:m.R.id});if(s){this.setProfileName(s);let t=await (0,g.w6)({name:s,chainId:m.R.id});t&&this.setProfileImage(t)}}}async syncBalance(t,s){let p=await (0,g.EG)({address:t,chainId:s.id,token:this.options?.tokens?.[s.id]?.address});this.setBalance(p.formatted,p.symbol)}syncConnectors(t){let s=[];t.connectors.forEach(({id:t,name:p})=>{t!==_.ky&&s.push({id:t,explorerId:F[t],imageId:T[t],imageUrl:this.options?.connectorImages?.[t],name:W[t]??p,type:Z[t]??"EXTERNAL"})}),this.setConnectors(s)}listenConnectors(t){let s=t.connectors.find(t=>t.id===_.ky);"undefined"!=typeof window&&s&&(window.addEventListener(_.yH,t=>{if(t.detail){let{info:p,provider:g}=t.detail;this.addConnector({id:_.ky,type:"ANNOUNCED",imageUrl:p.icon??this.options?.connectorImages?.[_.ky],name:p.name,provider:g,info:p}),s.isAuthorized({info:p,provider:g})}}),window.dispatchEvent(new Event(_.wd)))}}},94845:function(t,s,p){"use strict";p.d(s,{R:function(){return EIP6963Connector}});var g,m,v=p(74278),__classPrivateFieldSet=function(t,s,p,g,m){if("m"===g)throw TypeError("Private method is not writable");if("a"===g&&!m)throw TypeError("Private accessor was defined without a setter");if("function"==typeof s?t!==s||!m:!s.has(t))throw TypeError("Cannot write private member to an object whose class did not declare it");return"a"===g?m.call(t,p):m?m.value=p:s.set(t,p),p},__classPrivateFieldGet=function(t,s,p,g){if("a"===p&&!g)throw TypeError("Private accessor was defined without a getter");if("function"==typeof s?t!==s||!g:!s.has(t))throw TypeError("Cannot read private member from an object whose class did not declare it");return"m"===p?g:"a"===p?g.call(t):g?g.value:s.get(t)};let _="connectedRdns";let EIP6963Connector=class EIP6963Connector extends v._{constructor(t){super({chains:t.chains,options:{shimDisconnect:!0}}),this.id="eip6963",this.name="EIP6963",g.set(this,void 0),m.set(this,void 0),__classPrivateFieldSet(this,g,this.options.getProvider(),"f")}async connect(t){let s=await super.connect(t);return __classPrivateFieldGet(this,m,"f")&&this.storage?.setItem(_,__classPrivateFieldGet(this,m,"f").info.rdns),s}async disconnect(){await super.disconnect(),this.storage?.removeItem(_),__classPrivateFieldSet(this,m,void 0,"f")}async isAuthorized(t){let s=this.storage?.getItem(_);if(s){if(!t||s!==t.info.rdns)return!0;__classPrivateFieldSet(this,m,t,"f")}return super.isAuthorized()}async getProvider(){return Promise.resolve(__classPrivateFieldGet(this,m,"f")?.provider??__classPrivateFieldGet(this,g,"f"))}setEip6963Wallet(t){__classPrivateFieldSet(this,m,t,"f")}};g=new WeakMap,m=new WeakMap},29583:function(t,s,p){"use strict";p.d(s,{A7:function(){return F},FT:function(){return x},N$:function(){return g},WF:function(){return Z},aS:function(){return _},i1:function(){return m},kf:function(){return W},ky:function(){return T},q4:function(){return X},wd:function(){return Y},yH:function(){return Q},z3:function(){return v}});let g="walletConnect",m="injected",v="coinbaseWallet",_="safe",x="ledger",T="eip6963",F="eip155",W="wallet_addEthereumChain",Z="wagmi.wallet",Q="eip6963:announceProvider",Y="eip6963:requestProvider",X="3.1.0"},19568:function(t,s,p){"use strict";p.d(s,{T:function(){return walletConnectProvider}});var g=p(83756),m=p(29583);let v=g.j1.getBlockchainApiUrl();function walletConnectProvider({projectId:t}){return function(s){if(![1,5,11155111,10,420,42161,421613,137,80001,42220,1313161554,1313161555,56,97,43114,43113,100,8453,84531,7777777,999,324,280].includes(s.id))return null;let p=`${v}/v1/?chainId=${m.A7}:${s.id}&projectId=${t}`;return{chain:{...s,rpcUrls:{...s.rpcUrls,default:{http:[p]}}},rpcUrls:{http:[p]}}}}},37380:function(t,s,p){"use strict";p.d(s,{Cb:function(){return n},SB:function(){return state_r}});var g=p(97286);/**
 * @license
 * Copyright 2017 Google LLC
 * SPDX-License-Identifier: BSD-3-Clause
